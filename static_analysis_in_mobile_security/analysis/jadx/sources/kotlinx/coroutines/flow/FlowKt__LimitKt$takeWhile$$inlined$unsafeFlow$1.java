        ...
        switch (anonymousClass2.label) {
            case 0:
                ...
                try {
                    ...
                    if ($this$collectWhile$iv.collect(collector$iv2, anonymousClass2) == coroutine_suspended) {
                ...
                break;
            case 1:
                collector$iv = (FlowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$1) anonymousClass2.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    break;
