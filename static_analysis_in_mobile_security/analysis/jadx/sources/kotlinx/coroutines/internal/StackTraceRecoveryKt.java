...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM5563constructorimpl2;
        ...
        try {
            ...
            objM5563constructorimpl = Result.m5563constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m5566exceptionOrNullimpl(objM5563constructorimpl) == null) {
            obj2 = objM5563constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM5563constructorimpl2 = Result.m5563constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM5563constructorimpl2 = Result.m5563constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5566exceptionOrNullimpl(objM5563constructorimpl2) == null) {
            obj = objM5563constructorimpl2;
        }
