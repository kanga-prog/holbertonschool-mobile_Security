...
public final class AndroidAlertDialog_androidKt {
    ...
    public static final void m1307AlertDialogOix01E0(final Function0<Unit> onDismissRequest, final Function2<? super Composer, ? super Integer, Unit> confirmButton, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function4, Function2<? super Composer, ? super Integer, Unit> function5, Shape shape, long containerColor, long iconContentColor, long titleContentColor, long textContentColor, float tonalElevation, DialogProperties properties, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i5 != 0) {
            ...
            function6 = function4;
            $dirty2 |= $composer2.changedInstance(function6) ? 131072 : 65536;
        } else {
            function6 = function4;
        }
        int i6 = i & 64;
        if (i6 != 0) {
            ...
            function7 = function5;
            $dirty2 |= $composer2.changedInstance(function7) ? 1048576 : 524288;
        } else {
            function7 = function5;
        }
        ...
        if (($changed1 & 14) == 0) {
            $dirty3 |= ((i & 1024) == 0 && $composer2.changed(titleContentColor)) ? 4 : 2;
        }
        if (($changed1 & 112) == 0) {
            $dirty3 |= ((i & 2048) == 0 && $composer2.changed(textContentColor)) ? 32 : 16;
        }
        int i8 = i & 4096;
        if (i8 != 0) {
            $dirty3 |= 384;
        } else if (($changed1 & 896) == 0) {
            $dirty3 |= $composer2.changed(tonalElevation) ? 256 : 128;
        }
        int i9 = i & 8192;
        if (i9 != 0) {
            $dirty3 |= 3072;
        } else if (($changed1 & 7168) == 0) {
            $dirty3 |= $composer2.changed(properties) ? 2048 : 1024;
        }
        if (($dirty2 & 1533916891) == 306783378 && ($dirty3 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                Function2<? super Composer, ? super Integer, Unit> function14 = i4 != 0 ? null : function3;
                if (i5 != 0) {
                    function6 = null;
                }
                if (i6 != 0) {
                ...
                float tonalElevation3 = i8 != 0 ? AlertDialogDefaults.INSTANCE.m1304getTonalElevationD9Ej5fM() : tonalElevation;
                if (i9 != 0) {
            ...
            AlertDialog(onDismissRequest, modifier2, properties2, ComposableLambdaKt.composableLambda($composer2, 741647174, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        final Function2<Composer, Integer, Unit> function20 = function18;
                        final int i13 = i11;
                        final Function2<Composer, Integer, Unit> function21 = confirmButton;
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda($composer3, -1873210524, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1.1
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    final Function2<Composer, Integer, Unit> function22 = function20;
                                    final int i14 = i13;
                                    final Function2<Composer, Integer, Unit> function23 = function21;
                                    AlertDialogKt.m1306AlertDialogFlowRowixp7dh8(f2, f3, ComposableLambdaKt.composableLambda($composer4, 628285581, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.1.1.1
                                        ...
                                        public final void invoke(Composer $composer5, int $changed4) {
                                            ...
                                            if (($changed4 & 11) != 2 || !$composer5.getSkipping()) {
                                                ...
                                                if (function24 != null) {
                                                    function24.invoke($composer5, Integer.valueOf((i14 >> 9) & 14));
                                                    Unit unit = Unit.INSTANCE;
                                                }
                                                $composer5.endReplaceableGroup();
                                                function23.invoke($composer5, Integer.valueOf((i14 >> 3) & 14));
                                                if (ComposerKt.isTraceInProgress()) {
                        ...
                        Function2<Composer, Integer, Unit> function22 = function15;
                        Function2<Composer, Integer, Unit> function23 = function16;
                        Function2<Composer, Integer, Unit> function24 = function17;
                        Shape shape5 = shape4;
                        long j5 = j;
                        float f2 = f;
                        ...
                        int i14 = i11;
                        int i15 = i12;
                        AlertDialogKt.m1305AlertDialogContent4hvqGtA(composableLambda, null, function22, function23, function24, shape5, j5, f2, color, j6, j7, j8, $composer3, ((i14 >> 6) & 7168) | ((i14 >> 6) & 896) | 6 | ((i14 >> 6) & 57344) | ((i14 >> 6) & 458752) | ((i14 >> 6) & 3670016) | ((i15 << 15) & 29360128) | (i14 & 1879048192), (i15 & 14) | (i15 & 112), 2);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        final Function2<? super Composer, ? super Integer, Unit> function22 = function12;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.2
            ...
            public final void invoke(Composer composer, int i13) {
                AndroidAlertDialog_androidKt.m1307AlertDialogOix01E0(onDismissRequest, confirmButton, modifier6, function20, function21, function22, function23, shape5, j5, j6, j7, j8, f2, dialogProperties, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
            ...
            AndroidDialog_androidKt.Dialog(onDismissRequest, properties3, ComposableLambdaKt.composableLambda($composer2, 823217604, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidAlertDialog_androidKt.AlertDialog.3
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        Modifier modifierM538sizeInqDBjuR0$default = SizeKt.m538sizeInqDBjuR0$default(modifier4, AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
                        ...
                        Modifier modifier$iv = modifierM538sizeInqDBjuR0$default.then(SemanticsModifierKt.semantics$default(companion, false, (Function1) value$iv$iv, 1, null));
