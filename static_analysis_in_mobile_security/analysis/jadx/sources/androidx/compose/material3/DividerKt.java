    ...
    public static final void m1508Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                thickness2 = i3 != 0 ? DividerDefaults.INSTANCE.m1507getThicknessD9Ej5fM() : f;
                if ((i & 4) != 0) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DividerKt$Divider$1
            ...
            public final void invoke(Composer composer, int i5) {
                DividerKt.m1508Divider9IZ8Weo(modifier5, f2, j2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
