...
public final class DateRangePickerKt {
    ...
    public static final void DateRangePicker(final DateRangePickerState state, Modifier modifier, DatePickerFormatter dateFormatter, Function1<? super Long, Boolean> function1, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function3, boolean showModeToggle, DatePickerColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i4 != 0) {
                    function4 = new Function1<Long, Boolean>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.2
            ...
            ComposableLambda composableLambda3 = showModeToggle2 ? ComposableLambdaKt.composableLambda($composer2, -1062265737, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.5
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (invalid$iv$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                            value$iv$iv2 = new Function1<DisplayMode, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$DateRangePicker$5$1$1
                                ...
                                public final void m1486invokevCnGnXg(int displayMode) {
                                    dateRangePickerState.getStateData().m1725switchDisplayModevCnGnXg(displayMode);
                                }
                            };
                        ...
                        DatePickerKt.m1478DisplayModeToggleButtontER2X8s(modifierPadding, iM1488getDisplayModejFl4v0, (Function1) value$iv$iv2, $composer3, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            DatePickerKt.m1476DateEntryContainerau3_HiA(modifier2, composableLambda, composableLambda2, composableLambda3, colors2, textStyleFromToken, Dp.m5274constructorimpl(arg0$iv - other$iv), ComposableLambdaKt.composableLambda($composer2, -186850856, z, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.6
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        int i9 = i8;
                        DateRangePickerKt.SwitchableDateEntryContent(dateRangePickerState, datePickerFormatter2, function11, datePickerColors2, $composer3, (i9 & 14) | ((i9 >> 3) & 112) | ((i9 >> 3) & 896) | ((i9 >> 12) & 7168));
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.DateRangePicker.7
            ...
            public final void invoke(Composer composer, int i9) {
                DateRangePickerKt.DateRangePicker(state, modifier3, datePickerFormatter2, function11, function12, function13, z2, datePickerColors2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState state, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors colors, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            int iM1488getDisplayModejFl4v0 = state.m1488getDisplayModejFl4v0();
            final int i = $dirty;
            CrossfadeKt.Crossfade(DisplayMode.m1498boximpl(iM1488getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.SwitchableDateEntryContent.1
                @Override // kotlin.jvm.functions.Function1
                ...
                public final void m1487invokeQujVXRc(int mode, Composer $composer3, int $changed2) {
                    ...
                    if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                        ...
                        if (DisplayMode.m1501equalsimpl0(mode, DisplayMode.INSTANCE.m1506getPickerjFl4v0())) {
                            ...
                            int i2 = i;
                            DateRangePickerKt.DateRangePickerContent(stateData, datePickerFormatter, function2, datePickerColors, $composer3, (i2 & 112) | (i2 & 896) | (i2 & 7168));
                            $composer3.endReplaceableGroup();
                            ...
                            int i3 = i;
                            DateRangeInputKt.DateRangeInputContent(stateData2, datePickerFormatter2, function3, $composer3, (i3 & 896) | (i3 & 112));
                            $composer3.endReplaceableGroup();
                        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void VerticalMonthsList(final Function1<? super Long, Unit> function1, final StateData stateData, final LazyListState lazyListState, final DatePickerFormatter dateFormatter, final Function1<? super Long, Boolean> function2, final DatePickerColors colors, Composer $composer, final int $changed) {
        Object key1$iv;
        Object value$iv$iv;
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        LazyDslKt.LazyColumn(modifierSemantics$default, lazyListState2, null, false, null, null, null, false, new Function1<LazyListScope, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2
                            ...
                            public final void invoke2(LazyListScope LazyColumn) {
                                ...
                                final Function1<Long, Unit> function5 = function3;
                                final CalendarDate calendarDate2 = calendarDate;
                                final Function1<Long, Boolean> function6 = function4;
                                final int i2 = i;
                                ...
                                LazyListScope.CC.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int it, Composer $composer4, int $changed3) {
                                        ...
                                        if (($dirty3 & 731) != 146 || !$composer4.getSkipping()) {
                                            ...
                                            Function1<Long, Unit> function7 = function5;
                                            CalendarDate calendarDate3 = calendarDate2;
                                            Function1<Long, Boolean> function8 = function6;
                                            int i3 = i2;
                                            ...
                                            int i6 = i3 << 3;
                                            int i7 = i3 << 6;
                                            DatePickerKt.Month(month, function7, calendarDate3, stateData4, true, function8, datePickerFormatter3, datePickerColors3, $composer4, (i6 & 458752) | (i6 & 112) | 24576 | (i7 & 7168) | (3670016 & (i3 << 9)) | (29360128 & i7));
                                            ComposerKt.sourceInformationMarkerEnd($composer4);
                                            ComposerKt.sourceInformationMarkerEnd($composer4);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.3
            ...
            public final void invoke(Composer composer, int i2) {
                DateRangePickerKt.VerticalMonthsList(function1, stateData, lazyListState, dateFormatter, function2, colors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void m1484drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long color) {
        ...
        if (y1 == y2) {
            fM2800getWidthimpl = endX - startX;
        } else {
            fM2800getWidthimpl = isRtl ? -startX : Size.m2800getWidthimpl(drawRangeBackground.mo3442getSizeNHjbRc()) - startX;
        }
        DrawScope.CC.m3522drawRectnJ9OG0$default(contentDrawScope, color, jOffset, SizeKt.Size(fM2800getWidthimpl, itemStateLayerHeight), 0.0f, null, null, 0, 120, null);
        if (y1 != y2) {
            int y = (y2 - y1) - 1;
            while (y > 0) {
