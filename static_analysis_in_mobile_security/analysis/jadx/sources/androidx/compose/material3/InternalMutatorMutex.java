...
public final class InternalMutatorMutex {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        mutator3 = mutator;
                        try {
                            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(internalMutatorMutex.currentMutator, mutator3, null);
                ...
                case 2:
                    ...
                    mutator4 = null;
                    internalMutatorMutex = (InternalMutatorMutex) anonymousClass3.L$2;
                    owner$iv2 = null;
    ...
    static final class C03932<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03932(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, T t, Continuation<? super C03932> continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = internalMutatorMutex;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03932 c03932 = new C03932(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c03932.L$0 = obj;
            return c03932;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    c03932 = this;
                    CoroutineScope $this$coroutineScope = (CoroutineScope) c03932.L$0;
                    MutatePriority mutatePriority = c03932.$priority;
                    CoroutineContext.Element element = $this$coroutineScope.getCoroutineContext().get(Job.INSTANCE);
                    Intrinsics.checkNotNull(element);
                    Mutator mutator4 = new Mutator(mutatePriority, (Job) element);
                    c03932.this$0.tryMutateOrCancel(mutator4);
                    Mutex $this$withLock_u24default$iv3 = c03932.this$0.mutex;
                    function2 = c03932.$block;
                    obj = c03932.$receiver;
                    InternalMutatorMutex internalMutatorMutex2 = c03932.this$0;
                    c03932.L$0 = mutator4;
                    c03932.L$1 = $this$withLock_u24default$iv3;
                    c03932.L$2 = function2;
                    c03932.L$3 = obj;
                    c03932.L$4 = internalMutatorMutex2;
                    c03932.label = 1;
                    if ($this$withLock_u24default$iv3.lock(null, c03932) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    mutator = mutator4;
                    mutator2 = null;
                    ...
                    try {
                        c03932.L$0 = mutator;
                        c03932.L$1 = $this$withLock_u24default$iv;
                        c03932.L$2 = internalMutatorMutex;
                        c03932.L$3 = null;
                        c03932.L$4 = null;
                        c03932.label = 2;
                        objInvoke = function2.invoke(obj, c03932);
                        if (objInvoke == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        $result = objInvoke;
                ...
                case 1:
                    c03932 = this;
                    mutator2 = null;
                    internalMutatorMutex = (InternalMutatorMutex) c03932.L$4;
                    obj = c03932.L$3;
                    function2 = (Function2) c03932.L$2;
                    owner$iv = null;
                    $this$withLock_u24default$iv = (Mutex) c03932.L$1;
                    mutator = (Mutator) c03932.L$0;
                    ResultKt.throwOnFailure($result);
                    c03932.L$0 = mutator;
                    c03932.L$1 = $this$withLock_u24default$iv;
                    c03932.L$2 = internalMutatorMutex;
                ...
                case 2:
                    c03933 = this;
                    mutator3 = null;
                    internalMutatorMutex = (InternalMutatorMutex) c03933.L$2;
                    owner$iv2 = null;
                    $this$withLock_u24default$iv2 = (Mutex) c03933.L$1;
                    owner$iv3 = (Mutator) c03933.L$0;
                    try {
                        ResultKt.throwOnFailure($result);
                        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(internalMutatorMutex.currentMutator, owner$iv3, null);
                        $this$withLock_u24default$iv2.unlock(owner$iv2);
    ...
    public final <T, R> Object mutateWith(T t, MutatePriority priority, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C03932(priority, this, function2, t, null), continuation);
    }
