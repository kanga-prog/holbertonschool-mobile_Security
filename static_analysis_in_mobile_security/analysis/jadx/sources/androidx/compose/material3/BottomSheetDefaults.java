...
public final class BottomSheetDefaults {
    ...
    public final long getScrimColor(Composer $composer, int $changed) {
        ...
        long jM2969copywmQWz5c = Color.m2969copywmQWz5c(color, (14 & 1) != 0 ? Color.m2973getAlphaimpl(color) : 0.32f, (14 & 2) != 0 ? Color.m2977getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m2976getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m2974getBlueimpl(color) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets windowInsetsM560onlybOOhFvg = WindowInsetsKt.m560onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, $composer, 8), WindowInsetsSides.INSTANCE.m585getVerticalJoeWqyM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final void m1324DragHandlelgZ2HuY(Modifier modifier, float width, float height, Shape shape, long color, Composer $composer, final int $changed, final int i) {
        ...
        if ((46811 & $dirty) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                width2 = i3 != 0 ? SheetBottomTokens.INSTANCE.m2440getDockedDragHandleWidthD9Ej5fM() : f;
                if (i4 != 0) {
                ...
                if ((i & 16) != 0) {
                    ...
                    color2 = Color.m2969copywmQWz5c(color4, (14 & 1) != 0 ? Color.m2973getAlphaimpl(color4) : 0.4f, (14 & 2) != 0 ? Color.m2977getRedimpl(color4) : 0.0f, (14 & 4) != 0 ? Color.m2976getGreenimpl(color4) : 0.0f, (14 & 8) != 0 ? Color.m2974getBlueimpl(color4) : 0.0f);
                    $dirty &= -57345;
                } else {
                    color2 = j;
                }
            ...
            Modifier modifierM489paddingVpY3zN4$default = PaddingKt.m489paddingVpY3zN4$default(modifier3, 0.0f, SheetDefaultsKt.DragHandleVerticalPadding, 1, null);
            ...
            SurfaceKt.m1806SurfaceT9BRK9s(SemanticsModifierKt.semantics$default(modifierM489paddingVpY3zN4$default, false, (Function1) value$iv$iv, 1, null), shape2, color2, 0L, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda($composer2, -1039573072, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetDefaults$DragHandle$3
            ...
            public final void invoke(Composer composer, int i7) {
                this.$tmp0_rcvr.m1324DragHandlelgZ2HuY(modifier5, f2, f3, shape4, j2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
