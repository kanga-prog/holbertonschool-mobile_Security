...
public final class SheetState {
    ...
    public final Object animateTo$material3_release(SheetValue targetValue, float velocity, Continuation<? super Unit> continuation) throws Throwable {
        Object objAnimateTo = this.swipeableState.animateTo(targetValue, velocity, continuation);
    ...
    public final Object snapTo$material3_release(SheetValue targetValue, Continuation<? super Unit> continuation) {
        Object objSnapTo = this.swipeableState.snapTo(targetValue, continuation);
    ...
    public final Object settle$material3_release(float velocity, Continuation<? super Unit> continuation) throws Throwable {
