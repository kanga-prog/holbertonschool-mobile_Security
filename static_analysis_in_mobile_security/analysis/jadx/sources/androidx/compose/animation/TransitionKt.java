...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String label, Function3<? super S, ? super Composer, ? super Integer, Color> targetValueByState, Composer $composer, int $changed, int i) {
        ...
        Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function4 = (i & 1) != 0 ? new Function3<Transition.Segment<S>, Composer, Integer, SpringSpec<Color>>() { // from class: androidx.compose.animation.TransitionKt.animateColor.1
        ...
        State<Color> stateCreateTransitionAnimation = androidx.compose.animation.core.TransitionKt.createTransitionAnimation(transition, initialValue$iv, targetValue$iv, function4.invoke(transition.getSegment(), $composer, Integer.valueOf(($changed$iv >> 3) & 112)), typeConverter, label2, $composer, ($changed$iv & 14) | (57344 & ($changed$iv << 9)) | (458752 & ($changed$iv << 6)));
        $composer.endReplaceableGroup();
        $composer.endReplaceableGroup();
    ...
    public static final State<Color> m78animateColorDTcfvLk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> animationSpec, String label, Composer $composer, int $changed, int i) {
        ...
        State<Color> stateAnimateValue = InfiniteTransitionKt.animateValue(animateColor, Color.m2961boximpl(initialValue), Color.m2961boximpl(targetValue), converter, animationSpec, label2, $composer, InfiniteTransition.$stable | 4096 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 12) | (($changed << 3) & 57344) | (458752 & ($changed << 3)), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m79animateColorRIQooxk(InfiniteTransition animateColor, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        ...
        State<Color> stateM78animateColorDTcfvLk = m78animateColorDTcfvLk(animateColor, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 9) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
