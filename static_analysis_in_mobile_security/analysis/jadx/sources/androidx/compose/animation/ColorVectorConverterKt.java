        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            ...
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public final AnimationVector4D m40invoke8_81llA(long color) {
                    long jM2968convertvNxB06k = Color.m2968convertvNxB06k(color, ColorSpaces.INSTANCE.getOklab());
                    float l = Color.m2962component1impl(jM2968convertvNxB06k);
                    float a = Color.m2963component2impl(jM2968convertvNxB06k);
                    float b = Color.m2964component3impl(jM2968convertvNxB06k);
                    float alpha = Color.m2965component4impl(jM2968convertvNxB06k);
                ...
                public final long m41invokevNxB06k(AnimationVector4D vector) {
                    ...
                    return Color.m2968convertvNxB06k(ColorKt.Color(RangesKt.coerceIn(vector.getV2(), 0.0f, 1.0f), RangesKt.coerceIn(vector.getV3(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV4(), -0.5f, 0.5f), RangesKt.coerceIn(vector.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
