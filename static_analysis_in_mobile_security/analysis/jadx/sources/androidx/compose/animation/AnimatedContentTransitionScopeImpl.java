...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public EnterTransition mo12slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        ...
        if (m33isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf(IntSize.m5434getWidthimpl(this.m32getCurrentSizeYbymL2g()) - IntOffset.m5392getXimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m32getCurrentSizeYbymL2g()))));
                }
            });
        }
        if (m34isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf((-IntOffset.m5392getXimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m32getCurrentSizeYbymL2g()))) - it));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getUpDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
                ...
                public final Integer invoke(int it) {
                    return initialOffset.invoke(Integer.valueOf(IntSize.m5433getHeightimpl(this.m32getCurrentSizeYbymL2g()) - IntOffset.m5393getYimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m32getCurrentSizeYbymL2g()))));
                }
            });
        }
        return AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m23getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int it) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5393getYimpl(this.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), this.m32getCurrentSizeYbymL2g()))) - it));
            }
    ...
    public ExitTransition mo13slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        ...
        if (m33isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
                ...
                public final Integer invoke(int it) {
                    ...
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m5392getXimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
                }
            });
        }
        if (m34isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
                ...
                public final Integer invoke(int it) {
                    State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                    long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m5392getXimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m5434getWidthimpl(targetSize)));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m28getUpDKzdypw())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
                ...
                public final Integer invoke(int it) {
                    State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                    long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                    return targetOffset.invoke(Integer.valueOf((-IntOffset.m5393getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) - it));
                }
            });
        }
        return AnimatedContentTransitionScope.SlideDirection.m19equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m23getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            ...
            public final Integer invoke(int it) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5439getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5393getYimpl(this.this$0.m31calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize))) + IntSize.m5433getHeightimpl(targetSize)));
            }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            ...
            final Placeable placeableMo4225measureBRTryo0 = measurable.mo4225measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    ...
                    return (value == null || (finiteAnimationSpecMo75createAnimationSpecTemP2vQ = value.mo75createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo75createAnimationSpecTemP2vQ;
                }
            };
            ...
            final long jMo2621alignKFBX0sM = this.this$0.getContentAlignment().mo2621alignKFBX0sM(IntSizeKt.IntSize(placeableMo4225measureBRTryo0.getWidth(), placeableMo4225measureBRTryo0.getHeight()), stateAnimate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.CC.layout$default(measure, IntSize.m5434getWidthimpl(stateAnimate.getValue().getPackedValue()), IntSize.m5433getHeightimpl(stateAnimate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m4284place70tqf50$default(layout, placeableMo4225measureBRTryo0, jMo2621alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
