...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
        ...
        Map destination$iv$iv = new LinkedHashMap(MapsKt.mapCapacity(keyframes$animation_core_release.size()));
        Iterable $this$associateByTo$iv$iv$iv = keyframes$animation_core_release.entrySet();
