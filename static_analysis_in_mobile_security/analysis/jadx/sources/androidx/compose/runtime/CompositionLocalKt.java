...
public final class CompositionLocalKt {
    ...
    public static final void CompositionLocalProvider(final CompositionLocalContext context, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            ...
            for (Map.Entry<CompositionLocal<Object>, State<? extends Object>> entry : $this$map$iv.entrySet()) {
                ...
                destination$iv$iv.add(((ProvidableCompositionLocal) key).provides(entry.getValue().getValue()));
            }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.runtime.CompositionLocalKt.CompositionLocalProvider.3
            ...
            public final void invoke(Composer composer, int i) {
                CompositionLocalKt.CompositionLocalProvider(context, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
}
