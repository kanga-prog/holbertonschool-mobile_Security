...
public final class SnapshotKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Function1<Object, Unit> mergedReadObserver(final Function1<Object, Unit> function1, Function1<Object, Unit> function2, boolean mergeReadObserver) {
        final Function1<Object, Unit> function3 = mergeReadObserver ? function2 : null;
        if (function1 == null || function3 == null || Intrinsics.areEqual(function1, function3)) {
            return function1 == null ? function3 : function1;
        }
    ...
    public static final Map<StateRecord, StateRecord> optimisticMerges(MutableSnapshot currentSnapshot, MutableSnapshot applyingSnapshot, SnapshotIdSet invalidSnapshots) {
        ...
        while (i$iv < size) {
            ...
            if (current == null || (previous = readable(first, id, start)) == null) {
                modified = identityArraySet;
            } else if (Intrinsics.areEqual(current, previous)) {
                modified = identityArraySet;
            } else {
