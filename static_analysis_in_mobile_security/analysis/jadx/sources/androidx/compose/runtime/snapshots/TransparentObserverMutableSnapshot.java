...
public final class TransparentObserverMutableSnapshot extends MutableSnapshot {
    ...
    public TransparentObserverMutableSnapshot(MutableSnapshot parentSnapshot, Function1<Object, Unit> function1, Function1<Object, Unit> function2, boolean mergeParentObservers, boolean ownsParentSnapshot) {
        Function1<Object, Unit> writeObserver$runtime_release;
        Function1<Object, Unit> readObserver$runtime_release;
        super(0, SnapshotIdSet.INSTANCE.getEMPTY(), SnapshotKt.mergedReadObserver(function1, (parentSnapshot == null || (readObserver$runtime_release = parentSnapshot.getReadObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getReadObserver$runtime_release() : readObserver$runtime_release, mergeParentObservers), SnapshotKt.mergedWriteObserver(function2, (parentSnapshot == null || (writeObserver$runtime_release = parentSnapshot.getWriteObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getWriteObserver$runtime_release() : writeObserver$runtime_release));
