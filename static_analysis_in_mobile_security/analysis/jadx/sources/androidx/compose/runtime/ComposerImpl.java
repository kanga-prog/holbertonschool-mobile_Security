...
public final class ComposerImpl implements Composer {
    ...
    private final void updateNodeCountOverrides(int group, int newCount) {
        ...
        if (currentCount != newCount) {
            ...
            while (current != -1) {
                ...
                for (int pendingIndex = minPending; -1 < pendingIndex; pendingIndex--) {
    ...
    private final int groupCompoundKeyPart(SlotReader $this$groupCompoundKeyPart, int group) {
        ...
        if ($this$groupCompoundKeyPart.hasObjectKey(group)) {
            ...
            if (it != null) {
                ...
                return it instanceof MovableContent ? MovableContentKt.movableContentKey : it.hashCode();
            }
            return 0;
        }
    ...
    private final void insertMovableContentGuarded(List<Pair<MovableContentStateReference, MovableContentStateReference>> references) throws Throwable {
        ...
        List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list = this.lateChanges;
        int $i$f$withChanges = 0;
            ...
            while (index$iv < size) {
                ...
                if (from == null) {
                                ...
                                try {
                                    recomposeMovableContent$default(this, null, null, null, null, new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$2$1
                                        ...
                                        public final void invoke2() {
                                            ...
                                            List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list3 = offsetChanges;
                                            ...
                                            List savedChanges$iv2 = this_$iv.changes;
                                            try {
                                                this_$iv.changes = list3;
                                                SlotReader savedReader$iv = this_$iv2.reader;
                                                int[] savedCountOverrides$iv = this_$iv2.nodeCountOverrides;
                                                ...
                                                try {
                                                    ...
                                                    Unit unit = Unit.INSTANCE;
                                                    this_$iv2.reader = savedReader$iv;
                                                    this_$iv2.nodeCountOverrides = savedCountOverrides$iv;
                                                    Unit unit2 = Unit.INSTANCE;
                                                    this_$iv.changes = savedChanges$iv2;
                                                } catch (Throwable th) {
                                                    this_$iv2.reader = savedReader$iv;
                                                    this_$iv2.nodeCountOverrides = savedCountOverrides$iv;
                                                    throw th;
                    ...
                    if (!nodesToInsert.isEmpty()) {
                        record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$3
                            ...
                            public final void invoke2(Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
                                ...
                                List<Object> list3 = nodesToInsert;
                                int size2 = list3.size();
                                for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                                    Object item$iv2 = list3.get(index$iv2);
                                    int i3 = index$iv2;
                                    applier.insertBottomUp(base + i3, item$iv2);
                                    applier.insertTopDown(base + i3, item$iv2);
                                }
                            }
                        });
                    ...
                    try {
                        ...
                        int[] savedCountOverrides$iv = this.nodeCountOverrides;
                        try {
                            this.nodeCountOverrides = null;
                            try {
                                                    ...
                                                    try {
                                                        record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$5$1$2
                                                            ...
                                                            public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                                                                ...
                                                                Intrinsics.checkNotNullParameter(rememberManager, "rememberManager");
                                                                OffsetApplier offsetApplier = effectiveNodeIndex.element > 0 ? new OffsetApplier(applier, effectiveNodeIndex.element) : applier;
                                                                List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list3 = offsetChanges2;
                                                                int size2 = list3.size();
                                                                for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                                                                    Object item$iv2 = list3.get(index$iv2);
                                                                    ((Function3) item$iv2).invoke(offsetApplier, slots, rememberManager);
                                                        ...
                                                        th = th6;
                                                        savedReader$iv = savedReader$iv;
                                                        savedCountOverrides$iv = savedCountOverrides$iv;
                ...
                try {
                    ...
                    index$iv++;
                    size = i;
                    $i$f$withChanges = $i$f$withChanges;
                    list = list;
                    list2 = list2;
                    i2 = i2;
    ...
    private final <R> R recomposeMovableContent(ControlledComposition from, ControlledComposition to, Integer index, List<Pair<RecomposeScopeImpl, IdentityArraySet<Object>>> invalidations, Function0<? extends R> block) throws Throwable {
        ...
        try {
            ...
            this.isComposing = true;
            this.nodeIndex = 0;
            List<Pair<RecomposeScopeImpl, IdentityArraySet<Object>>> list = invalidations;
            int i3 = 0;
            int i4 = 0;
            int size = list.size();
            while (i4 < size) {
    ...
    public final void releaseMovableGroupAtCurrent(final MovableContentStateReference reference, SlotWriter slots) {
        ...
        try {
            ...
            if (RecomposeScopeImpl.INSTANCE.hasAnchoredRecomposeScopes$runtime_release(slotTable, listMoveTo)) {
                ...
                SlotWriter writer$iv2 = slotTable.openWriter();
                try {
                    RecomposeScopeImpl.INSTANCE.adoptAnchoredScopes$runtime_release(writer$iv2, listMoveTo, recomposeScopeOwner);
                    Unit unit = Unit.INSTANCE;
                    writer$iv2.close();
                } catch (Throwable th) {
                    writer$iv2.close();
