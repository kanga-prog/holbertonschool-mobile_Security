...
public final class IdentityScopeMap<T> {
    ...
    private final IdentityArraySet<T> getOrCreateIdentitySet(Object value) {
        ...
        if (size < valueOrder.length) {
            ...
            IdentityArraySet<T> identityArraySet = identityArraySetArr[valueIndex];
            if (identityArraySet == null) {
                identityArraySet = new IdentityArraySet<>();
                identityArraySetArr[valueIndex] = identityArraySet;
            }
            if (insertIndex < size) {
        ...
        Object[] objArrCopyOf = Arrays.copyOf(identityArraySetArr, newSize);
        Intrinsics.checkNotNullExpressionValue(objArrCopyOf, "copyOf(this, newSize)");
        IdentityArraySet[] newScopeSets = (IdentityArraySet[]) objArrCopyOf;
        IdentityArraySet<T> identityArraySet2 = new IdentityArraySet<>();
        newScopeSets[size] = identityArraySet2;
        Object[] newValues = Arrays.copyOf(values, newSize);
        Intrinsics.checkNotNullExpressionValue(newValues, "copyOf(this, newSize)");
        ...
        if (insertIndex < size) {
            ArraysKt.copyInto(valueOrder, newKeyOrder, insertIndex + 1, insertIndex, size);
        }
        newKeyOrder[insertIndex] = size;
        if (insertIndex > 0) {
            ArraysKt.copyInto$default(valueOrder, newKeyOrder, 0, 0, insertIndex, 6, (Object) null);
        }
