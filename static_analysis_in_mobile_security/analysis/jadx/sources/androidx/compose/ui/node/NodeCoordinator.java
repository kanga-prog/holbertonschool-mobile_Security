...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope, Function1<Canvas, Unit> {
    ...
    public final /* synthetic */ <T> void m4436visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        int i4 = 0;
        boolean includeTail$iv3 = NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type);
        NodeCoordinator this_$iv3 = this;
        Modifier.Node stopNode$iv = this_$iv3.getTail();
        if (includeTail$iv3 || (stopNode$iv = stopNode$iv.getParent()) != null) {
            Modifier.Node node$iv = this_$iv3.headNode(includeTail$iv3);
                            ...
                            if (!((this_$iv$iv.getKindSet() & type) != 0) || !(node$iv2 instanceof DelegatingNode)) {
                                ...
                                while (node$iv$iv != null) {
                                    ...
                                    if (!((next$iv.getKindSet() & type) != 0)) {
                                        i3 = i4;
                                        includeTail$iv3 = includeTail$iv3;
                                        this_$iv3 = this_$iv3;
                                    } else {
                                        count$iv++;
                                        i3 = i4;
                                ...
                                if (count$iv == 1) {
                                    i4 = i2;
                                    includeTail$iv3 = includeTail$iv2;
                                    this_$iv3 = this_$iv2;
                                }
                            }
                        }
    ...
    private final boolean m4416hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m4338has64DMado(nodeHeadNode, type);
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        int type$iv3 = NodeKind.m4443constructorimpl(4);
        NodeCoordinator this_$iv3 = this;
        boolean includeTail$iv$iv = NodeKindKt.m4452getIncludeSelfInTraversalH91voCI(type$iv3);
    ...
    public Object getParentData() {
        ...
        kotlin.jvm.internal.Ref.ObjectRef data = new kotlin.jvm.internal.Ref.ObjectRef();
        NodeChain this_$iv2 = getLayoutNode().getNodes();
        Modifier.Node node$iv = this_$iv2.getTail();
        while (node$iv != null) {
    ...
    public final void onMeasured() throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    int type$iv3 = NodeKind.m4443constructorimpl(128);
                                                ...
                                                while (node$iv$iv$iv != null) {
                                                    ...
                                                    if ((next$iv$iv.getKindSet() & type$iv3) != 0) {
                                                        ...
                                                        if (count$iv$iv == i4) {
                                                            nodePop = next$iv$iv;
                                                            type$iv3 = type$iv3;
                                                            $i$f$withoutReadObservation3 = $i$f$withoutReadObservation3;
                                                        } else {
                                                            MutableVector mutableVector2 = mutableVector == null ? new MutableVector(new Modifier.Node[16], 0) : mutableVector;
                                                            Modifier.Node theNode$iv$iv = nodePop;
                                                            if (theNode$iv$iv != null) {
    ...
    public final void m4417hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m4417hit1hIXUjU(NodeCoordinatorKt.m4441nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
    ...
    public final void m4418hitNearJHbHoSQ(final Modifier.Node $this$hitNear_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m4418hitNearJHbHoSQ(NodeCoordinatorKt.m4441nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
        ...
        if ($this$speculativeHit_u2dJHbHoSQ != null) {
            if (hitTestSource.interceptOutOfBoundsChildEvents($this$speculativeHit_u2dJHbHoSQ)) {
                hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                    ...
                    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        this.this$0.m4421speculativeHitJHbHoSQ(NodeCoordinatorKt.m4441nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                    }
                });
                return;
            } else {
                m4421speculativeHitJHbHoSQ(NodeCoordinatorKt.m4441nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo4439entityTypeOLwlOKw(), NodeKind.m4443constructorimpl(2)), hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                return;
            }
        }
        mo4361hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int iM4443constructorimpl = NodeKind.m4443constructorimpl(2);
        ...
        return ancestor1 == other.getLayoutNode() ? other : ancestor1.getInnerCoordinator$ui_release();
    }
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int type$iv2 = NodeKind.m4443constructorimpl(16);
        ...
        if ((self$iv$iv.getAggregateChildKindSet() & type$iv2) == 0) {
            return false;
        }
    ...
    protected final float m4425distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        ...
        long jM4424calculateMinimumTouchTargetPaddingE7KxVPU = m4424calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m2800getWidthimpl(jM4424calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m2797getHeightimpl(jM4424calculateMinimumTouchTargetPaddingE7KxVPU);
