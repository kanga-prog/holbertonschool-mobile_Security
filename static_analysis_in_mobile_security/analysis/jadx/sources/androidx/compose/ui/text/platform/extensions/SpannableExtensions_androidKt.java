...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable $this$setTextIndent, TextIndent textIndent, float contextFontSize, Density density) {
        ...
        if (textIndent != null) {
            if ((!TextUnit.m5452equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) || !TextUnit.m5452equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) && !TextUnitKt.m5473isUnspecifiedR2X_6o(textIndent.getFirstLine()) && !TextUnitKt.m5473isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                long jM5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(textIndent.getFirstLine());
                float fM5455getValueimpl = 0.0f;
                if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
                    ...
                    firstLine = TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA, TextUnitType.INSTANCE.m5487getEmUIouoOA()) ? TextUnit.m5455getValueimpl(textIndent.getFirstLine()) * contextFontSize : 0.0f;
                }
                long jM5454getTypeUIouoOA2 = TextUnit.m5454getTypeUIouoOA(textIndent.getRestLine());
                if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA2, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
                    fM5455getValueimpl = density.mo326toPxR2X_6o(textIndent.getRestLine());
                } else if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA2, TextUnitType.INSTANCE.m5487getEmUIouoOA())) {
                    fM5455getValueimpl = TextUnit.m5455getValueimpl(textIndent.getRestLine()) * contextFontSize;
                }
                float restLine = fM5455getValueimpl;
    ...
    private static final float m5015resolveLineHeightInPxo2QH7mI(long lineHeight, float contextFontSize, Density density) {
        long jM5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(lineHeight);
        if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
            return density.mo326toPxR2X_6o(lineHeight);
        }
        if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA, TextUnitType.INSTANCE.m5487getEmUIouoOA())) {
    ...
    private static final void setFontAttributes(final Spannable $this$setFontAttributes, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(contextFontSpanStyle, fontRelatedSpanStyles, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int start, int end) {
                ...
                spannable.setSpan(new TypefaceSpan(function5.invoke(fontFamily, fontWeight, fontStyleM4864boximpl, FontSynthesis.m4873boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4882getAllGVVA2EU()))), start, end, 33);
            }
        });
    }
    ...
    private static final MetricAffectingSpan m5014createLetterSpacingSpaneAf_CNQ(long letterSpacing, Density density) {
        long jM5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(letterSpacing);
        if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
    ...
    public static final void m5019setFontSizeKmRG4DE(Spannable setFontSize, long fontSize, Density density, int start, int end) {
        ...
        Intrinsics.checkNotNullParameter(density, "density");
        long jM5454getTypeUIouoOA = TextUnit.m5454getTypeUIouoOA(fontSize);
        if (TextUnitType.m5483equalsimpl0(jM5454getTypeUIouoOA, TextUnitType.INSTANCE.m5488getSpUIouoOA())) {
