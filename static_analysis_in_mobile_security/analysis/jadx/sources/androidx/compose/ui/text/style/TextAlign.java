...
public final class TextAlign {
    ...
    public static String m5132toStringimpl(int arg0) {
        if (m5130equalsimpl0(arg0, Left)) {
            return "Left";
        }
        if (m5130equalsimpl0(arg0, Right)) {
            return "Right";
        }
        if (m5130equalsimpl0(arg0, Center)) {
            return "Center";
        }
        if (m5130equalsimpl0(arg0, Justify)) {
            return "Justify";
        }
        if (m5130equalsimpl0(arg0, Start)) {
            return "Start";
        }
        return m5130equalsimpl0(arg0, End) ? "End" : "Invalid";
    }
