...
public final class Font extends AndroidPreloadedFont {
    ...
    public /* synthetic */ Font(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        if ((i2 & 4) == 0) {
            iM4872getNormal_LCdwA = i;
        } else {
            iM4872getNormal_LCdwA = FontStyle.INSTANCE.m4872getNormal_LCdwA();
        }
        this(file, normal, iM4872getNormal_LCdwA, settings, null);
    }
    ...
    public String toString() {
        return "Font(file=" + this.file + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4869toStringimpl(getStyle())) + ')';
    }
}
