...
public interface TextForegroundStyle {
    ...
    public final /* synthetic */ class CC {
        public static TextForegroundStyle $default$merge(final TextForegroundStyle _this, TextForegroundStyle other) {
            ...
            if (!(other instanceof BrushStyle) || (_this instanceof BrushStyle)) {
                return ((other instanceof BrushStyle) || !(_this instanceof BrushStyle)) ? other.takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.style.TextForegroundStyle.merge.2
                    {
                        super(0);
                    }
