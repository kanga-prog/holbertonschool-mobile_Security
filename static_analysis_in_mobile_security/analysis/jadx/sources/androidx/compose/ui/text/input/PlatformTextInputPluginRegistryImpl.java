...
public final class PlatformTextInputPluginRegistryImpl implements PlatformTextInputPluginRegistry {
    ...
    public <T extends PlatformTextInputAdapter> T rememberAdapter(PlatformTextInputPlugin<T> plugin, Composer composer, int i) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            orCreateAdapter = getOrCreateAdapter(plugin);
            composer.updateRememberedValue(orCreateAdapter);
        } else {
            orCreateAdapter = objRememberedValue;
        }
        composer.endReplaceableGroup();
        final AdapterHandle adapterHandle = (AdapterHandle) orCreateAdapter;
        ...
        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            ...
            compositionScopedCoroutineScopeCanceller = objRememberedValue2;
        }
        composer.endReplaceableGroup();
    ...
    private final <T extends PlatformTextInputAdapter> AdapterWithRefCount<T> instantiateAdapter(PlatformTextInputPlugin<T> plugin) {
        ...
        PlatformTextInputAdapter platformTextInputAdapterInvoke = this.factory.invoke(plugin, input);
        ...
        PlatformTextInputAdapter newAdapter = platformTextInputAdapterInvoke;
        AdapterWithRefCount<T> adapterWithRefCount = new AdapterWithRefCount<>(this, newAdapter);
