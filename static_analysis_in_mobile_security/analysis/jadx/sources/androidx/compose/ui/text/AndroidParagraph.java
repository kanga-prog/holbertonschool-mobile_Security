...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        int alignment = AndroidParagraph_androidKt.m4638toLayoutAlignAMY3VfE(style.m4797getTextAlignbuA522U());
        TextAlign textAlignM4797getTextAlignbuA522U = style.m4797getTextAlignbuA522U();
        int justificationMode = textAlignM4797getTextAlignbuA522U == null ? false : TextAlign.m5130equalsimpl0(textAlignM4797getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m5136getJustifye0LSkKk()) ? 1 : 0;
        int hyphens = AndroidParagraph_androidKt.m4640toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak lineBreakM4795getLineBreakLgCVezo = style.m4795getLineBreakLgCVezo();
        int breakStrategy = AndroidParagraph_androidKt.m4639toLayoutBreakStrategyu6PBz3U(lineBreakM4795getLineBreakLgCVezo != null ? LineBreak.Strategy.m5071boximpl(LineBreak.m5062getStrategyfcGXIks(lineBreakM4795getLineBreakLgCVezo.getMask())) : null);
        LineBreak lineBreakM4795getLineBreakLgCVezo2 = style.m4795getLineBreakLgCVezo();
        int lineBreakStyle = AndroidParagraph_androidKt.m4641toLayoutLineBreakStyle4a2g8L8(lineBreakM4795getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m5081boximpl(LineBreak.m5063getStrictnessusljTpc(lineBreakM4795getLineBreakLgCVezo2.getMask())) : null);
        LineBreak lineBreakM4795getLineBreakLgCVezo3 = style.m4795getLineBreakLgCVezo();
        int lineBreakWordStyle = AndroidParagraph_androidKt.m4642toLayoutLineBreakWordStylegvcdTPQ(lineBreakM4795getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m5092boximpl(LineBreak.m5064getWordBreakjp8hJ3c(lineBreakM4795getLineBreakLgCVezo3.getMask())) : null);
        if (ellipsis) {
        ...
        if (ellipsis && firstLayout.getHeight() > Constraints.m5217getMaxHeightimpl(constraints) && maxLines > 1) {
            int calculatedMaxLines = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m5217getMaxHeightimpl(constraints));
        ...
        if ($this$placeholderRects_u24lambda_u246 instanceof Spanned) {
            ...
            int $i$f$mapTo = 0;
            int i3 = 0;
            for (int length = $this$mapTo$iv$iv.length; i3 < length; length = length) {
                Object item$iv$iv = $this$mapTo$iv$iv[i3];
                ...
                CharSequence $this$placeholderRects_u24lambda_u247 = $this$placeholderRects_u24lambda_u246;
                ...
                if (isPlaceholderSpanEllipsized || isPlaceholderSpanTruncated || exceedsMaxLines) {
                    ...
                    switch (span.getVerticalAlign()) {
                        ...
                        case 6:
                            ...
                            int $i$f$mapTo2 = $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244_u24lambda_u243.ascent;
                            lineBaseline = ((($i$f$mapTo2 + $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244_u24lambda_u243.descent) - span.getHeightPx()) / 2) + $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244.getLineBaseline(line);
                            break;
                        default:
                ...
                i3++;
                $this$placeholderRects_u24lambda_u246 = $this$placeholderRects_u24lambda_u247;
                i2 = i4;
