...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int iFloatToIntBits = ((((((((((((((((((((((Float.floatToIntBits(this.scaleX) * 31) + Float.floatToIntBits(this.scaleY)) * 31) + Float.floatToIntBits(this.alpha)) * 31) + Float.floatToIntBits(this.translationX)) * 31) + Float.floatToIntBits(this.translationY)) * 31) + Float.floatToIntBits(this.shadowElevation)) * 31) + Float.floatToIntBits(this.rotationX)) * 31) + Float.floatToIntBits(this.rotationY)) * 31) + Float.floatToIntBits(this.rotationZ)) * 31) + Float.floatToIntBits(this.cameraDistance)) * 31) + TransformOrigin.m3359hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31;
        boolean z = this.clip;
        ?? r2 = z;
        if (z) {
            r2 = 1;
        }
        int i = (iFloatToIntBits + r2) * 31;
        RenderEffect renderEffect = this.renderEffect;
        return ((((((i + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m2978hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m2978hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m3052hashCodeimpl(this.compositingStrategy);
    }
