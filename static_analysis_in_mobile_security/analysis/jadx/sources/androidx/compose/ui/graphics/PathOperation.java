...
public final class PathOperation {
    ...
    public static String m3261toStringimpl(int arg0) {
        if (m3259equalsimpl0(arg0, Difference)) {
            return "Difference";
        }
        if (m3259equalsimpl0(arg0, Intersect)) {
            return "Intersect";
        }
        if (m3259equalsimpl0(arg0, Union)) {
            return "Union";
        }
        if (m3259equalsimpl0(arg0, Xor)) {
            return "Xor";
        }
        return m3259equalsimpl0(arg0, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
