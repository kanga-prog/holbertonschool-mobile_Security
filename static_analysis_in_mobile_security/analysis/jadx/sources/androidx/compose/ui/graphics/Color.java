...
public final class Color {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ long m2996hsvJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            ...
            return companion.m3011hsvJlNiLsg(f, f2, f3, f5, srgb);
        }
        ...
        public static /* synthetic */ long m2995hslJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            ...
            return companion.m3010hslJlNiLsg(f, f2, f3, f5, srgb);
        }

        /* JADX WARN: Code duplicated, block: B:24:0x0034  */
        /* JADX INFO: renamed from: hsl-JlNiLsg, reason: not valid java name */
        public final long m3010hslJlNiLsg(float hue, float saturation, float lightness, float alpha, Rgb colorSpace) {
            boolean z;
            Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
            if (0.0f <= hue && hue <= 360.0f) {
                if (0.0f <= saturation && saturation <= 1.0f) {
