                    ...
                    try {
                        try {
                            ...
                            try {
                                ...
                                i3--;
                                i = startIndex;
                                lastReusableIndex = lastReusableIndex;
                            } catch (Throwable th3) {
                                th = th3;
                                snapshot$iv.restoreCurrent(previous$iv$iv);
                                throw th;
    ...
    public final MeasurePolicy createMeasurePolicy(final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> block) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
                ...
                if (isIntermediate) {
                    return LayoutNodeSubcompositionsState.this.getIntermediateMeasurePolicy$ui_release().invoke(LayoutNodeSubcompositionsState.this.intermediateMeasureScope, Constraints.m5206boximpl(constraints));
                }
                LayoutNodeSubcompositionsState.this.currentIndex = 0;
                LayoutNodeSubcompositionsState.this.intermediateMeasureScope.m4245setLookaheadConstraintsBRTryo0(constraints);
                ...
                LayoutNodeSubcompositionsState.this.intermediateMeasureScope.m4246setLookaheadSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
