...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String strM5204getEnterjXw82LU;
        Intrinsics.checkNotNullParameter(animation, "animation");
        this.animation = animation;
        if (getAnimation().m5190getAnimationObject().getCurrentState().booleanValue()) {
            strM5204getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m5205getExitjXw82LU();
        } else {
            strM5204getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m5204getEnterjXw82LU();
        }
        this.state = strM5204getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ void setState(ComposeAnimationState composeAnimationState) {
        m5196setState7IW2chM(((AnimatedVisibilityState) composeAnimationState).m5203unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition<Boolean> transitionM5190getAnimationObject = getAnimation().m5190getAnimationObject();
        Pair<Boolean, Boolean> pairM5194toCurrentTargetPair7IW2chM = m5194toCurrentTargetPair7IW2chM(getState());
        boolean current = pairM5194toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = pairM5194toCurrentTargetPair7IW2chM.component2().booleanValue();
        transitionM5190getAnimationObject.seek(Boolean.valueOf(current), Boolean.valueOf(target), animationTimeNanos);
    }
