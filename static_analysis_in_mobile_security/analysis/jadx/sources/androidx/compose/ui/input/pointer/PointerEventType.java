...
public final class PointerEventType {
    ...
    public static String m4058toStringimpl(int arg0) {
        if (m4056equalsimpl0(arg0, Press)) {
            return "Press";
        }
        if (m4056equalsimpl0(arg0, Release)) {
            return "Release";
        }
        if (m4056equalsimpl0(arg0, Move)) {
            return "Move";
        }
        if (m4056equalsimpl0(arg0, Enter)) {
            return "Enter";
        }
        if (m4056equalsimpl0(arg0, Exit)) {
            return "Exit";
        }
        return m4056equalsimpl0(arg0, Scroll) ? "Scroll" : "Unknown";
    }
