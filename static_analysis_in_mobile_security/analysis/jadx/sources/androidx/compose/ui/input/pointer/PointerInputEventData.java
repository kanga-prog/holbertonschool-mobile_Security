...
public final /* data */ class PointerInputEventData {
    ...
    public int hashCode() {
        int iM4090hashCodeimpl = ((((((PointerId.m4090hashCodeimpl(this.id) * 31) + FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(this.uptime)) * 31) + Offset.m2733hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2733hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        ?? r2 = z;
        if (z) {
            r2 = 1;
        }
        int iFloatToIntBits = (((((iM4090hashCodeimpl + r2) * 31) + Float.floatToIntBits(this.pressure)) * 31) + PointerType.m4179hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((iFloatToIntBits + (z2 ? 1 : z2)) * 31) + this.historical.hashCode()) * 31) + Offset.m2733hashCodeimpl(this.scrollDelta);
    }
