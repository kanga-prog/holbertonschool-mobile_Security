...
public final class WindowRecomposerPolicy {
    ...
    public final Recomposer createAndInstallWindowRecomposer$ui_release(View rootView) {
        ...
        final Job unsetJob = BuildersKt__Builders_commonKt.launch$default(globalScope, HandlerDispatcherKt.from(handler, "windowRecomposer cleanup").getImmediate(), null, new WindowRecomposerPolicy$createAndInstallWindowRecomposer$unsetJob$1(newRecomposer, rootView, null), 2, null);
