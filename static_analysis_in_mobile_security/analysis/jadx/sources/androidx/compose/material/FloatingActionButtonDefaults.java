...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1123elevationixp7dh8(float defaultElevation, float pressedElevation, Composer $composer, int $changed, int i) {
        ...
        FloatingActionButtonElevation floatingActionButtonElevationM1124elevationxZ9QkE = m1124elevationxZ9QkE(defaultElevation, pressedElevation, Dp.m5274constructorimpl(8), Dp.m5274constructorimpl(8), $composer, $this$dp$iv | 3456 | ($changed & 112) | (($changed << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return floatingActionButtonElevationM1124elevationxZ9QkE;
    }
