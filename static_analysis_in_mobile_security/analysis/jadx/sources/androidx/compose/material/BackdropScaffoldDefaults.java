...
public final class BackdropScaffoldDefaults {
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl(16)), CornerSizeKt.m740CornerSize0680j_4(Dp.m5274constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        long jM1052getSurface0d7_KjU = MaterialTheme.INSTANCE.getColors($composer, 6).m1052getSurface0d7_KjU();
        long jM2969copywmQWz5c = Color.m2969copywmQWz5c(jM1052getSurface0d7_KjU, (14 & 1) != 0 ? Color.m2973getAlphaimpl(jM1052getSurface0d7_KjU) : 0.6f, (14 & 2) != 0 ? Color.m2977getRedimpl(jM1052getSurface0d7_KjU) : 0.0f, (14 & 4) != 0 ? Color.m2976getGreenimpl(jM1052getSurface0d7_KjU) : 0.0f, (14 & 8) != 0 ? Color.m2974getBlueimpl(jM1052getSurface0d7_KjU) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
