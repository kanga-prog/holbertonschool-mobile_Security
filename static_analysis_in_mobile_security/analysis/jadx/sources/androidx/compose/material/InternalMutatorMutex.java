...
public final class InternalMutatorMutex {
    ...
    static final class C02882<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02882(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, T t, Continuation<? super C02882> continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = internalMutatorMutex;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02882 c02882 = new C02882(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c02882.L$0 = obj;
            return c02882;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    c02882 = this;
                    CoroutineScope $this$coroutineScope = (CoroutineScope) c02882.L$0;
                    MutatePriority mutatePriority = c02882.$priority;
                    CoroutineContext.Element element = $this$coroutineScope.getCoroutineContext().get(Job.INSTANCE);
                    Intrinsics.checkNotNull(element);
                    Mutator mutator4 = new Mutator(mutatePriority, (Job) element);
                    c02882.this$0.tryMutateOrCancel(mutator4);
                    Mutex $this$withLock_u24default$iv3 = c02882.this$0.mutex;
                    function2 = c02882.$block;
                    obj = c02882.$receiver;
                    InternalMutatorMutex internalMutatorMutex2 = c02882.this$0;
                    c02882.L$0 = mutator4;
                    c02882.L$1 = $this$withLock_u24default$iv3;
                    c02882.L$2 = function2;
                    c02882.L$3 = obj;
                    c02882.L$4 = internalMutatorMutex2;
                    c02882.label = 1;
                    if ($this$withLock_u24default$iv3.lock(null, c02882) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    mutator = mutator4;
                    mutator2 = null;
                    ...
                    try {
                        c02882.L$0 = mutator;
                        c02882.L$1 = $this$withLock_u24default$iv;
                        c02882.L$2 = internalMutatorMutex;
                        c02882.L$3 = null;
                        c02882.L$4 = null;
                        c02882.label = 2;
                        objInvoke = function2.invoke(obj, c02882);
                        if (objInvoke == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        $result = objInvoke;
                ...
                case 1:
                    c02882 = this;
                    mutator2 = null;
                    internalMutatorMutex = (InternalMutatorMutex) c02882.L$4;
                    obj = c02882.L$3;
                    function2 = (Function2) c02882.L$2;
                    owner$iv = null;
                    $this$withLock_u24default$iv = (Mutex) c02882.L$1;
                    mutator = (Mutator) c02882.L$0;
                    ResultKt.throwOnFailure($result);
                    c02882.L$0 = mutator;
                    c02882.L$1 = $this$withLock_u24default$iv;
                    c02882.L$2 = internalMutatorMutex;
                ...
                case 2:
                    c02883 = this;
                    mutator3 = null;
                    internalMutatorMutex = (InternalMutatorMutex) c02883.L$2;
                    owner$iv2 = null;
                    $this$withLock_u24default$iv2 = (Mutex) c02883.L$1;
                    owner$iv3 = (Mutator) c02883.L$0;
                    try {
                        ResultKt.throwOnFailure($result);
                        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(internalMutatorMutex.currentMutator, owner$iv3, null);
                        $this$withLock_u24default$iv2.unlock(owner$iv2);
    ...
    public final <T, R> Object mutateWith(T t, MutatePriority priority, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C02882(priority, this, function2, t, null), continuation);
    }
