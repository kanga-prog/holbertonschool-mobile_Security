...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1133defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long jM1300defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1300defaultRippleColor5vOe2sY(Color.INSTANCE.m2997getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha rippleAlphaM1299defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1299defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2997getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
