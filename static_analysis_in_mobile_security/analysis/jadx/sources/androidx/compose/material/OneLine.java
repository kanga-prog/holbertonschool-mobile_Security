...
final class OneLine {
    ...
    public final void ListItem(Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> text, final Function2<? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        Modifier modifier3;
        ...
        ComposerKt.sourceInformation($composer2, "C(ListItem)P(1)142@5412L1102:ListItem.kt#jmzs0o");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if ((i & 4) != 0) {
            ...
            $dirty |= $composer2.changedInstance(text) ? 256 : 128;
        }
        if ((i & 8) != 0) {
            $dirty |= 3072;
        ...
        if ((46811 & $dirty2) == 9362 && $composer2.getSkipping()) {
            ...
            Modifier modifier$iv = SizeKt.m522heightInVpY3zN4$default(modifier4, minHeight, 0.0f, 2, null);
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1825884304, "C155@5989L262:ListItem.kt#jmzs0o");
            $composer2.startReplaceableGroup(1825884304);
            ComposerKt.sourceInformation($composer2, "144@5502L460");
            if (function2 != null) {
                ...
                Modifier modifierM541widthInVpY3zN4$default = SizeKt.m541widthInVpY3zN4$default(modifierAlign, Dp.m5274constructorimpl(arg0$iv + other$iv), 0.0f, 2, null);
                float f = IconLeftPadding;
                float f2 = IconVerticalPadding;
                Modifier modifier$iv2 = PaddingKt.m491paddingqDBjuR0$default(modifierM541widthInVpY3zN4$default, f, f2, 0.0f, f2, 4, null);
                ...
                int i6 = ((48 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer2, 1962584985, "C153@5954L6:ListItem.kt#jmzs0o");
            ...
            $composer2.endReplaceableGroup();
            Modifier modifier$iv3 = PaddingKt.m491paddingqDBjuR0$default($this$ListItem_u24lambda_u243.align(RowScope.CC.weight$default($this$ListItem_u24lambda_u243, Modifier.INSTANCE, 1.0f, false, 2, null), Alignment.INSTANCE.getCenterVertically()), ContentLeftPadding, 0.0f, ContentRightPadding, 0.0f, 10, null);
            Alignment contentAlignment$iv2 = Alignment.INSTANCE.getCenterStart();
            $composer2.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)69@3214L67,70@3286L130:Box.kt#2w3rfo");
            MeasurePolicy measurePolicy$iv3 = BoxKt.rememberBoxMeasurePolicy(contentAlignment$iv2, false, $composer2, ((48 >> 3) & 14) | ((48 >> 3) & 112));
            ...
            int i8 = ((48 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, 1962585274, "C160@6243L6:ListItem.kt#jmzs0o");
            text.invoke($composer2, Integer.valueOf(($dirty2 >> 6) & 14));
            ComposerKt.sourceInformationMarkerEnd($composer2);
            ComposerKt.sourceInformationMarkerEnd($composer2);
            $composer2.endReplaceableGroup();
            $composer2.endNode();
            ...
            if (function3 != null) {
                Modifier modifier$iv4 = PaddingKt.m491paddingqDBjuR0$default($this$ListItem_u24lambda_u243.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterVertically()), 0.0f, 0.0f, TrailingRightPadding, 0.0f, 11, null);
                $composer2.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer2, "CC(Box)P(2,1,3)69@3214L67,70@3286L130:Box.kt#2w3rfo");
                ...
                int i10 = ((0 >> 6) & 112) | 6;
                ComposerKt.sourceInformationMarkerStart($composer2, 1962585509, "C166@6478L10:ListItem.kt#jmzs0o");
                function3.invoke($composer2, Integer.valueOf(($dirty2 >> 9) & 14));
                ComposerKt.sourceInformationMarkerEnd($composer2);
                ComposerKt.sourceInformationMarkerEnd($composer2);
                $composer2.endReplaceableGroup();
                $composer2.endNode();
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.OneLine.ListItem.2
            ...
            public final void invoke(Composer composer, int i11) {
                OneLine.this.ListItem(modifier5, function2, text, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
}
