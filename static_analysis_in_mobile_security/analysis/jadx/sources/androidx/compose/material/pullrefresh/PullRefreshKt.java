...
public final class PullRefreshKt {
    ...
    public static final Modifier pullRefresh(Modifier $this$pullRefresh, final PullRefreshState state, final boolean enabled) {
        ...
        return InspectableValueKt.inspectableWrapper($this$pullRefresh, noInspectorInfo, $this$pullRefresh_u24lambda_u241);
    }
    ...
    public static final Modifier pullRefresh(Modifier $this$pullRefresh, final Function1<? super Float, Float> onPull, final Function2<? super Float, ? super Continuation<? super Float>, ? extends Object> onRelease, final boolean enabled) {
        ...
        Function1<InspectorInfo, Unit> noInspectorInfo = InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshKt$pullRefresh$$inlined$debugInspectorInfo$2
            ...
            public final void invoke2(InspectorInfo $this$null) {
                Intrinsics.checkNotNullParameter($this$null, "$this$null");
                $this$null.setName("pullRefresh");
                $this$null.getProperties().set("onPull", onPull);
        ...
        Modifier $this$inspectable$iv = InspectableValueKt.inspectableWrapper($this$pullRefresh, noInspectorInfo, $this$pullRefresh_u24lambda_u243);
