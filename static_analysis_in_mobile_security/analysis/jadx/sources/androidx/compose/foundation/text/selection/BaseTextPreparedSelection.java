...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            baseTextPreparedSelection.setCursor(TextRange.m4763getEndimpl(baseTextPreparedSelection.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            if (TextRange.m4762getCollapsedimpl(baseTextPreparedSelection.selection)) {
                ...
                baseTextPreparedSelection.setCursor(TextRange.m4766getMinimpl(baseTextPreparedSelection.selection));
            } else {
                baseTextPreparedSelection.setCursor(TextRange.m4765getMaximpl(baseTextPreparedSelection.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection<T> baseTextPreparedSelection = this;
            baseTextPreparedSelection.selection = TextRangeKt.TextRange(TextRange.m4768getStartimpl(baseTextPreparedSelection.originalSelection), TextRange.m4763getEndimpl(baseTextPreparedSelection.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
