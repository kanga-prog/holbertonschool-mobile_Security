...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo239measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int iM5434getWidthimpl = IntSize.m5434getWidthimpl(layoutSize);
        int iM5433getHeightimpl = IntSize.m5433getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map2 = this.baselineCache;
        Intrinsics.checkNotNull(map2);
        return measure.layout(iM5434getWidthimpl, iM5433getHeightimpl, map2, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope $this$draw) throws Throwable {
        ...
        Paragraph localParagraph = getLayoutCache().getParagraph();
        ...
        boolean willClip = getLayoutCache().getDidOverflow();
        if (willClip) {
            float width = IntSize.m5434getWidthimpl(getLayoutCache().getLayoutSize());
            float height = IntSize.m5433getHeightimpl(getLayoutCache().getLayoutSize());
        ...
        try {
            ...
            if (brush != null) {
                ...
                Paragraph.CC.m4663painthn5TExg$default(localParagraph, canvas2, brush, alpha, shadow2, textDecoration2, drawStyle2, 0, 64, null);
                canvas = canvas2;
            } else {
                ...
                if (($this$isSpecified$iv != Color.INSTANCE.m3007getUnspecified0d7_KjU() ? 1 : 0) != 0) {
                    ...
                    if ($this$isSpecified$iv2 != Color.INSTANCE.m3007getUnspecified0d7_KjU()) {
                        color = this.style.m4789getColor0d7_KjU();
                    } else {
                ...
                canvas = canvas2;
                try {
                    Paragraph.CC.m4661paintLG529CI$default(localParagraph, canvas, color, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                } catch (Throwable th2) {
                    th = th2;
                    if (willClip) {
                        canvas.restore();
