...
public final class PagerStateKt {
    ...
    public static final PagerState rememberPagerState(int initialPage, float initialPageOffsetFraction, final Function0<Integer> pageCount, Composer $composer, int $changed, int i) {
        ...
        Object objM2617rememberSaveable = RememberSaveableKt.m2617rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) key1$iv2, $composer, 72, 4);
        PagerStateImpl $this$rememberPagerState_u24lambda_u241 = (PagerStateImpl) objM2617rememberSaveable;
        $this$rememberPagerState_u24lambda_u241.getPageCountState().setValue(pageCount);
        PagerStateImpl pagerStateImpl = (PagerStateImpl) objM2617rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
