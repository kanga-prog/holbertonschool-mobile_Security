...
public final class PagerKt {
    ...
    public static final void m706HorizontalPagerxYaah8o(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        Composer $composer2 = $composer.startRestartGroup(1491175841);
        ComposerKt.sourceInformation($composer2, "C(HorizontalPager)P(10,4,1,7!1,8:c#ui.unit.Dp,12!1,11,9!1,6)113@6091L28,122@6441L620:Pager.kt#g6yjnt");
        int $dirty3 = $changed;
        int $dirty4 = $changed1;
        if ((i & 1) != 0) {
            $dirty3 |= 6;
        ...
        if (i5 != 0) {
            ...
            $dirty3 |= $composer2.changed(contentPadding) ? 256 : 128;
        }
        int i6 = i & 8;
        if (i6 != 0) {
            $dirty3 |= 3072;
            ...
            pageSize2 = pageSize;
            $dirty3 |= $composer2.changed(pageSize2) ? 2048 : 1024;
        } else {
            pageSize2 = pageSize;
        }
        int i7 = i & 16;
        ...
        if (i8 != 0) {
            ...
            $dirty3 |= $composer2.changed(pageSpacing) ? 131072 : 65536;
        }
        int i9 = i & 64;
        if (i9 != 0) {
            $dirty3 |= 1572864;
            ...
            vertical = verticalAlignment;
            $dirty3 |= $composer2.changed(vertical) ? 1048576 : 524288;
        } else {
            vertical = verticalAlignment;
        }
        if (($changed & 29360128) == 0) {
            $dirty3 |= ((i & 128) == 0 && $composer2.changed(flingBehavior)) ? 8388608 : 4194304;
        }
        int i10 = i & 256;
        if (i10 != 0) {
            $dirty3 |= 100663296;
        } else if (($changed & 234881024) == 0) {
            $dirty3 |= $composer2.changed(userScrollEnabled) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
        }
        int i11 = i & 512;
        if (i11 != 0) {
            ...
            if (($changed & 1879048192) == 0) {
                $dirty3 |= $composer2.changed(reverseLayout) ? 536870912 : 268435456;
            }
            $dirty = $dirty3;
        }
        int $dirty5 = i & 1024;
        if ($dirty5 != 0) {
            ...
            $dirty4 |= $composer2.changedInstance(function1) ? 4 : 2;
        }
        int i12 = i & 2048;
        if (i12 != 0) {
            $dirty4 |= 16;
        ...
        if ((i & 4096) != 0) {
            ...
            $dirty4 |= $composer2.changedInstance(pageContent) ? 256 : 128;
        }
        if (i12 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty4 & 731) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                contentPadding2 = i5 != 0 ? PaddingKt.m480PaddingValues0680j_4(Dp.m5274constructorimpl(0)) : contentPadding;
                PageSize pageSize4 = i6 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                int beyondBoundsPageCount3 = i7 != 0 ? 0 : i2;
                float pageSpacing3 = i8 != 0 ? Dp.m5274constructorimpl(0) : pageSpacing;
                Alignment.Vertical verticalAlignment3 = i9 != 0 ? Alignment.INSTANCE.getCenterVertically() : vertical;
                if ((i & 128) != 0) {
                    i3 = 1491175841;
                    flingBehavior2 = PagerDefaults.INSTANCE.m704flingBehaviorPfoAEA0(state, null, null, null, null, 0.0f, 0.0f, $composer2, ($dirty & 14) | 12582912, 126);
                    $dirty &= -29360129;
                } else {
                    i3 = 1491175841;
                    flingBehavior2 = flingBehavior;
                }
                boolean userScrollEnabled3 = i10 != 0 ? true : userScrollEnabled;
                boolean reverseLayout3 = i11 != 0 ? false : reverseLayout;
                Function1<? super Integer, ? extends Object> function3 = $dirty5 != 0 ? null : function1;
                if (i12 != 0) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(i3, $dirty2, $dirty1, "androidx.compose.foundation.pager.HorizontalPager (Pager.kt:105)");
            }
            LazyLayoutPagerKt.m700Pagerfs30GE4(modifier3, state, contentPadding2, reverseLayout2, Orientation.Horizontal, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function2, Alignment.INSTANCE.getCenterHorizontally(), verticalAlignment2, pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), (($dirty1 << 3) & 112) | 392 | (($dirty2 >> 9) & 7168) | (($dirty1 << 6) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        final int i13 = beyondBoundsPageCount2;
        ...
        final Function1<? super Integer, ? extends Object> function4 = function2;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$1
            ...
            public final void invoke(Composer composer, int i14) {
                PagerKt.m706HorizontalPagerxYaah8o(state, modifier5, paddingValues, pageSize5, i13, f, vertical2, snapFlingBehavior, z, z2, function4, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m705HorizontalPagerAlbwjTQ(final int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Vertical verticalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($changed & 896) == 0) {
            if ((i & 4) == 0) {
                state2 = state;
                int i3 = $composer2.changed(state2) ? 256 : 128;
                $dirty4 |= i3;
            } else {
                state2 = state;
            }
        ...
        if (($changed & 234881024) == 0) {
            if ((i & 256) == 0) {
                ...
                int i9 = $composer2.changed(snapFlingBehavior) ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 33554432;
                $dirty4 |= i9;
            } else {
                snapFlingBehavior = flingBehavior;
            }
        ...
        if (i11 != 0) {
            ...
            $dirty5 |= $composer2.changed(reverseLayout) ? 4 : 2;
        }
        int i12 = i & 2048;
        if (i12 != 0) {
            $dirty5 |= 48;
        } else if (($changed1 & 112) == 0) {
            $dirty5 |= $composer2.changedInstance(function1) ? 32 : 16;
        }
        int i13 = i & 4096;
        if (i13 != 0) {
            $dirty5 |= 128;
        ...
        if ((i & 8192) != 0) {
            ...
            $dirty5 |= $composer2.changedInstance(pageContent) ? 2048 : 1024;
        }
        int $dirty6 = $dirty5;
        if (i13 == 4096 && (1533916891 & $dirty4) == 306783378 && ($dirty6 & 5851) == 1170 && $composer2.getSkipping()) {
            $composer2.skipToGroupEnd();
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                contentPadding2 = i4 != 0 ? PaddingKt.m480PaddingValues0680j_4(Dp.m5274constructorimpl(0)) : contentPadding;
                pageSize3 = i5 != 0 ? PageSize.Fill.INSTANCE : pageSize2;
                beyondBoundsPageCount2 = i6 != 0 ? 0 : beyondBoundsPageCount;
                pageSpacing2 = i7 != 0 ? Dp.m5274constructorimpl(0) : pageSpacing;
                verticalAlignment2 = i8 != 0 ? Alignment.INSTANCE.getCenterVertically() : verticalAlignment;
                if ((i & 256) != 0) {
                ...
                boolean reverseLayout4 = i11 != 0 ? false : reverseLayout;
                Function1<? super Integer, ? extends Object> function3 = i12 != 0 ? null : function1;
                if (i13 != 0) {
            ...
            LazyLayoutPagerKt.m700Pagerfs30GE4(modifier2, state2, contentPadding2, reverseLayout2, Orientation.Horizontal, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function2, Alignment.INSTANCE.getCenterHorizontally(), verticalAlignment2, pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 >> 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty1 << 9) & 7168) | (($dirty2 >> 9) & 458752) | (($dirty2 >> 9) & 3670016) | (($dirty2 << 6) & 29360128) | (($dirty2 << 6) & 234881024) | (($dirty2 << 15) & 1879048192), ($dirty1 & 112) | 392 | (($dirty2 >> 12) & 7168) | (($dirty1 << 3) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        final int i15 = beyondBoundsPageCount3;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$HorizontalPager$3
            ...
            public final void invoke(Composer composer, int i16) {
                PagerKt.m705HorizontalPagerAlbwjTQ(pageCount, modifier4, pagerState, paddingValues, pageSize5, i15, f, vertical, snapFlingBehavior2, z, z2, function4, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m708VerticalPagerxYaah8o(final PagerState state, Modifier modifier, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(pageContent, "pageContent");
        Composer $composer2 = $composer.startRestartGroup(-1457068767);
        ComposerKt.sourceInformation($composer2, "C(VerticalPager)P(11,5,1,8!1,9:c#ui.unit.Dp,3!1,12,10!1,7)299@15710L28,308@16058L618:Pager.kt#g6yjnt");
        int $dirty3 = $changed;
        int $dirty4 = $changed1;
        if ((i & 1) != 0) {
            $dirty3 |= 6;
        ...
        if (i9 != 0) {
            ...
            horizontal = horizontalAlignment;
            $dirty3 |= $composer2.changed(horizontal) ? 1048576 : 524288;
        } else {
            horizontal = horizontalAlignment;
        }
        if (($changed & 29360128) == 0) {
        ...
        if (i12 == 2048 && ($dirty & 1533916891) == 306783378 && ($dirty4 & 731) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                int beyondBoundsPageCount3 = i7 != 0 ? 0 : i2;
                float pageSpacing3 = i8 != 0 ? Dp.m5274constructorimpl(0) : pageSpacing;
                Alignment.Horizontal horizontalAlignment3 = i9 != 0 ? Alignment.INSTANCE.getCenterHorizontally() : horizontal;
                if ((i & 128) != 0) {
                    i3 = -1457068767;
                    flingBehavior2 = PagerDefaults.INSTANCE.m704flingBehaviorPfoAEA0(state, null, null, null, null, 0.0f, 0.0f, $composer2, ($dirty & 14) | 12582912, 126);
                    $dirty &= -29360129;
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(i3, $dirty2, $dirty1, "androidx.compose.foundation.pager.VerticalPager (Pager.kt:291)");
            }
            LazyLayoutPagerKt.m700Pagerfs30GE4(modifier3, state, contentPadding2, reverseLayout2, Orientation.Vertical, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function2, horizontalAlignment2, Alignment.INSTANCE.getCenterVertically(), pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 << 3) & 112) | ($dirty2 & 896) | (($dirty2 >> 18) & 7168) | (($dirty2 >> 6) & 458752) | (($dirty2 >> 6) & 3670016) | (($dirty2 << 9) & 29360128) | (($dirty2 << 9) & 234881024) | (($dirty2 << 18) & 1879048192), (($dirty1 << 3) & 112) | 3080 | (($dirty2 >> 12) & 896) | (($dirty1 << 6) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$1
            ...
            public final void invoke(Composer composer, int i14) {
                PagerKt.m708VerticalPagerxYaah8o(state, modifier5, paddingValues, pageSize5, i13, f, horizontal2, snapFlingBehavior, z, z2, function4, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final void m707VerticalPagerAlbwjTQ(final int pageCount, Modifier modifier, PagerState state, PaddingValues contentPadding, PageSize pageSize, int beyondBoundsPageCount, float pageSpacing, Alignment.Horizontal horizontalAlignment, SnapFlingBehavior flingBehavior, boolean userScrollEnabled, boolean reverseLayout, Function1<? super Integer, ? extends Object> function1, NestedScrollConnection pageNestedScrollConnection, final Function4<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> pageContent, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (i13 == 4096 && (1533916891 & $dirty4) == 306783378 && ($dirty6 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                beyondBoundsPageCount2 = i6 != 0 ? 0 : beyondBoundsPageCount;
                pageSpacing2 = i7 != 0 ? Dp.m5274constructorimpl(0) : pageSpacing;
                horizontalAlignment2 = i8 != 0 ? Alignment.INSTANCE.getCenterHorizontally() : horizontalAlignment;
                if ((i & 256) != 0) {
                    flingBehavior2 = PagerDefaults.INSTANCE.m704flingBehaviorPfoAEA0(state3, null, null, null, null, 0.0f, 0.0f, $composer2, (($dirty >> 6) & 14) | 12582912, 126);
                    $dirty &= -234881025;
                } else {
            ...
            LazyLayoutPagerKt.m700Pagerfs30GE4(modifier2, state2, contentPadding2, reverseLayout2, Orientation.Vertical, flingBehavior3, userScrollEnabled2, beyondBoundsPageCount2, pageSpacing2, pageSize3, pageNestedScrollConnection2, function2, horizontalAlignment2, Alignment.INSTANCE.getCenterVertically(), pageContent, $composer2, (($dirty2 >> 3) & 14) | 24576 | (($dirty2 >> 3) & 112) | (($dirty2 >> 3) & 896) | (($dirty1 << 9) & 7168) | (($dirty2 >> 9) & 458752) | (($dirty2 >> 9) & 3670016) | (($dirty2 << 6) & 29360128) | (($dirty2 << 6) & 234881024) | (($dirty2 << 15) & 1879048192), ($dirty1 & 112) | 3080 | (($dirty2 >> 15) & 896) | (($dirty1 << 3) & 57344), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            flingBehavior4 = flingBehavior3;
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerKt$VerticalPager$3
            ...
            public final void invoke(Composer composer, int i16) {
                PagerKt.m707VerticalPagerAlbwjTQ(pageCount, modifier4, pagerState, paddingValues, pageSize5, i15, f, horizontal, snapFlingBehavior2, z, z2, function4, nestedScrollConnection, pageContent, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), RecomposeScopeImplKt.updateChangedFlags($changed1), i);
            }
        });
    }
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final PagerState pagerState, final PagerSnapDistance pagerSnapDistance, final DecayAnimationSpec<Float> decayAnimationSpec, final float snapPositionalThreshold) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.pager.PagerKt.SnapLayoutInfoProvider.1
            ...
            public float calculateSnappingOffset(Density $this$calculateSnappingOffset, float currentVelocity) {
                ...
                boolean isForward = PagerKt.isScrollingForward(pagerState);
                float offsetFromSnappedPosition = PagerKt.dragGestureDelta(pagerState) / getLayoutInfo().getPageSize();
                ...
                } else if (Math.abs(offsetFromSnappedPositionOverflow) <= snapPositionalThreshold ? !isForward : isForward) {
                    finalDistance = upperBoundOffset;
                } else {
                    finalDistance = lowerBoundOffset;
                }
