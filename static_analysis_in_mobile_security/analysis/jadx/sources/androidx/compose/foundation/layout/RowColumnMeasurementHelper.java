...
public final class RowColumnMeasurementHelper {
    ...
    public final RowColumnMeasureHelperResult m514measureWithoutPlacing_EkL_Y(MeasureScope measureScope, long constraints, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (weight > 0.0f) {
                ...
                int iM5218getMaxWidthimpl = Constraints.m5218getMaxWidthimpl(constraints2);
                Placeable placeableMo4225measureBRTryo0 = this.placeables[i4];
                if (placeableMo4225measureBRTryo0 == null) {
                    int weightChildrenCount2 = iM5218getMaxWidthimpl != Integer.MAX_VALUE ? iM5218getMaxWidthimpl - fixedSpace2 : Integer.MAX_VALUE;
                    placeableMo4225measureBRTryo0 = child.mo4225measureBRTryo0(OrientationIndependentConstraints.m469toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m457copyyUG9Ft0(constraints2, (8 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints2) : 0, (8 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints2) : weightChildrenCount2, (8 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints2) : 0, (8 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints2) : 0), this.orientation));
                }
                Placeable placeable = placeableMo4225measureBRTryo0;
                int spaceAfterLastNoWeight2 = Math.min(i3, (iM5218getMaxWidthimpl - fixedSpace2) - mainAxisSize(placeable));
        ...
        if (weightChildrenCount == 0) {
            ...
            int remainingToTarget = (targetSpace - fixedSpace2) - ((weightChildrenCount - 1) * i3);
            float weightUnitSpace = totalWeight > 0.0f ? remainingToTarget / totalWeight : 0.0f;
            Iterator<Integer> it = RangesKt.until(startIndex, endIndex).iterator();
            int iRoundToInt = 0;
            while (it.hasNext()) {
                iRoundToInt += MathKt.roundToInt(RowColumnImplKt.getWeight(this.rowColumnParentData[((IntIterator) it).nextInt()]) * weightUnitSpace);
            }
            int childMainAxisSize = remainingToTarget - iRoundToInt;
            int i5 = startIndex;
            while (i5 < i2) {
                if (this.placeables[i5] == null) {
                    ...
                    int remainder2 = MathKt.roundToInt(weightUnitSpace * weight2) + remainderUnit;
                    ...
                    Placeable placeable2 = child2.mo4225measureBRTryo0(OrientationIndependentConstraints.m469toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m454constructorimpl(i, childMainAxisSize2, 0, Constraints.m5217getMaxHeightimpl(constraints2)), this.orientation));
    ...
    public final void placeHelper(Placeable.PlacementScope placeableScope, RowColumnMeasureHelperResult measureResult, int crossAxisOffset, LayoutDirection layoutDirection) {
        ...
        int i2 = measureResult.getStartIndex();
        int i3 = i2;
        for (int endIndex = measureResult.getEndIndex(); i3 < endIndex; endIndex = endIndex) {
