...
public final class RowColumnImplKt {
    ...
    public static final MeasurePolicy m512rowColumnMeasurePolicyTDGSqEk(final LayoutOrientation orientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> arrangement, final float arrangementSpacing, final SizeMode crossAxisSize, final CrossAxisAlignment crossAxisAlignment) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.RowColumnImplKt$rowColumnMeasurePolicy$1
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MinIntrinsicWidthMeasureBlock(orientation).invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$minIntrinsicWidth.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MinIntrinsicHeightMeasureBlock(orientation).invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$minIntrinsicHeight.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> measurables, int height) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MaxIntrinsicWidthMeasureBlock(orientation).invoke(measurables, Integer.valueOf(height), Integer.valueOf($this$maxIntrinsicWidth.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                return ((Number) RowColumnImplKt.MaxIntrinsicHeightMeasureBlock(orientation).invoke(measurables, Integer.valueOf(width), Integer.valueOf($this$maxIntrinsicHeight.mo321roundToPx0680j_4(arrangementSpacing)))).intValue();
            }
        };
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int intrinsicSize(List<? extends IntrinsicMeasurable> list, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function3, int crossAxisAvailable, int mainAxisSpacing, LayoutOrientation layoutOrientation, LayoutOrientation intrinsicOrientation) {
        if (layoutOrientation == intrinsicOrientation) {
            return intrinsicMainAxisSize(list, function2, crossAxisAvailable, mainAxisSpacing);
        }
        return intrinsicCrossAxisSize(list, function3, function2, crossAxisAvailable, mainAxisSpacing);
    }
    ...
    private static final int intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> list, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function3, int mainAxisAvailable, int mainAxisSpacing) {
        int iRoundToInt;
        float f;
        int iRoundToInt2;
        ...
        while (true) {
            ...
            if ((weight == 0.0f ? 1 : 0) != 0) {
                ...
                crossAxisMax = Math.max(crossAxisMax, function3.invoke(child, Integer.valueOf(mainAxisSpace)).intValue());
            } else if (weight > 0.0f) {
                totalWeight += weight;
            }
            index$iv++;
        ...
        while (index$iv2 < size2) {
            ...
            if (weight2 > f) {
                ...
                crossAxisMax = Math.max(crossAxisMax, function3.invoke(child2, Integer.valueOf(iRoundToInt2)).intValue());
            }
            index$iv2++;
            f = 0.0f;
        }
