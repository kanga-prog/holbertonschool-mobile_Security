...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m166basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        ...
        int iM232getImmediatelyZbEOnfQ = (i5 & 2) != 0 ? MarqueeAnimationMode.INSTANCE.m232getImmediatelyZbEOnfQ() : i2;
        int i7 = (i5 & 4) != 0 ? DefaultMarqueeDelayMillis : i3;
        if ((i5 & 8) != 0) {
            i6 = MarqueeAnimationMode.m226equalsimpl0(iM232getImmediatelyZbEOnfQ, MarqueeAnimationMode.INSTANCE.m232getImmediatelyZbEOnfQ()) ? i7 : 0;
        } else {
            i6 = i4;
        }
        return m165basicMarquee1Mj1MLw(modifier, i, iM232getImmediatelyZbEOnfQ, i7, i6, (i5 & 16) != 0 ? DefaultMarqueeSpacing : marqueeSpacing, (i5 & 32) != 0 ? DefaultMarqueeVelocity : f);
    }
    ...
    public static final AnimationSpec<Float> m167createMarqueeAnimationSpecZ4HSEVQ(int iterations, float targetValue, int initialDelayMillis, int delayMillis, float velocity, Density density) {
        ...
        if (iterations == Integer.MAX_VALUE) {
            return AnimationSpecKt.m91infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, startOffset, 2, null);
        }
        return AnimationSpecKt.m93repeatable91I0pcU$default(iterations, tweenSpecVelocityBasedTween, null, startOffset, 4, null);
    }
