...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo245calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long bounds) {
        ...
        Offset offsetM2720boximpl = Offset.m2720boximpl(Offset.INSTANCE.m2747getZeroF1C5BW0());
        int index$iv$iv = 0;
        int size = changes.size();
        while (index$iv$iv < size) {
            Object item$iv$iv = changes.get(index$iv$iv);
            PointerInputChange c = (PointerInputChange) item$iv$iv;
            long acc = offsetM2720boximpl.getPackedValue();
            offsetM2720boximpl = Offset.m2720boximpl(Offset.m2736plusMKHz9U(acc, c.getScrollDelta()));
            index$iv$iv++;
            changes = changes;
        }
        return Offset.m2738timestuRUvjQ(offsetM2720boximpl.getPackedValue(), -calculateMouseWheelScroll.mo327toPx0680j_4(Dp.m5274constructorimpl(64)));
    }
}
