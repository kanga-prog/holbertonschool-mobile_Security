...
final class LowVelocityApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public Object approachAnimation(ScrollScope scope, float offset, float velocity, Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        float fAbs = Math.abs(offset);
        SnapLayoutInfoProvider $this$approachAnimation_u24lambda_u240 = this.layoutInfoProvider;
        float targetOffset = (fAbs + $this$approachAnimation_u24lambda_u240.calculateSnapStepSize(this.density)) * Math.signum(velocity);
        Object objAnimateSnap = SnapFlingBehaviorKt.animateSnap(scope, targetOffset, offset, animationState, this.lowVelocityAnimationSpec, function1, continuation);
