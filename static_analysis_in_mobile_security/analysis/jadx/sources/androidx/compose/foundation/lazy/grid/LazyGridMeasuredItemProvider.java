...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public final LazyGridMeasuredItem m626getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo645measure0kLqBqw = this.measureScope.mo645measure0kLqBqw(index, constraints);
        ...
        return createItem(index, key, contentType, crossAxisSize, mainAxisSpacing, listMo645measure0kLqBqw);
    }
