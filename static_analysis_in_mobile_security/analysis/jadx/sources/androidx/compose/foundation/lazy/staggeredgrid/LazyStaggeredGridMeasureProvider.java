...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    public final LazyStaggeredGridMeasuredItem m683getAndMeasurejy6DScQ(int index, long span) {
        ...
        return createItem(index, (int) (span >> 32), ((int) (4294967295L & span)) - ((int) (span >> 32)), key, contentType, this.measureScope.mo645measure0kLqBqw(index, m682childConstraintsJhjzzOo((int) (span >> 32), $i$f$unpackInt2 - ((int) (span >> 32)))));
    }
