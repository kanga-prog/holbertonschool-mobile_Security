                ...
                if (inIx + 1 != inLength) {
                    ...
                    if (Character.isSurrogatePair(c2, low)) {
                        ...
                        try {
                            ...
                            out.put(outIx5, (byte) ((codePoint & 63) | 128));
                            outIx2 = outIx5;
                        } catch (IndexOutOfBoundsException e3) {
                            outIx = outIx5;
                            int badWriteIndex3 = out.position() + Math.max(inIx, (outIx - out.position()) + 1);
                            throw new ArrayIndexOutOfBoundsException("Failed writing " + in.charAt(inIx) + " at index " + badWriteIndex3);
                        }
                    }
                }
