...
public final class DurationKt {
    ...
    /* JADX WARN: Code duplicated, block: B:184:0x00df A[EDGE_INSN: B:184:0x00df->B:52:0x00df BREAK  A[LOOP:1: B:39:0x0085->B:50:0x00c4], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:50:0x00c4 A[LOOP:1: B:39:0x0085->B:50:0x00c4, LOOP_END] */
    public static final long parseDuration(String value, boolean strictIso) {
        ...
        long result = Duration.INSTANCE.m6991getZEROUwyO8pc();
        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index2 < length3) {
                if (value.charAt(index2) == 'T') {
                    ...
                    if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                        ...
                        String str5 = str3;
                        long result2 = Duration.m6924plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(whole), unit));
                        Intrinsics.checkNotNull(component, str5);
                        String strSubstring = component.substring(dotIndex);
                        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                        result = Duration.m6924plusLRDsOJo(result2, toDuration(Double.parseDouble(strSubstring), unit));
                        str3 = str5;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
                        ...
                        result = Duration.m6924plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(component), unit));
                        str3 = str3;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
            ...
            if (!strictIso) {
                ...
                if (StringsKt.regionMatches(value, index, "Infinity", 0, Math.max(length3 - index, "Infinity".length()), true)) {
                    result = Duration.INSTANCE.m6989getINFINITEUwyO8pc();
                } else {
                    ...
                    while (index < length) {
                        ...
                        if (dotIndex2 > 0) {
                            ...
                            String str6 = str;
                            long result4 = Duration.m6924plusLRDsOJo(result3, toDuration(Long.parseLong(whole2), unit2));
                            Intrinsics.checkNotNull(component2, "null cannot be cast to non-null type java.lang.String");
                            String strSubstring2 = component2.substring(dotIndex2);
                            Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                            result3 = Duration.m6924plusLRDsOJo(result4, toDuration(Double.parseDouble(strSubstring2), unit2));
                            if (index < length) {
                                throw new IllegalArgumentException("Fractional component must be last");
                            }
                            str = str6;
                        } else {
                            result3 = Duration.m6924plusLRDsOJo(result3, toDuration(Long.parseLong(component2), unit2));
                            str = str;
                        }
                    }
                    result = result3;
        ...
        return isNegative ? Duration.m6941unaryMinusUwyO8pc(result) : result;
    }
    ...
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m6888constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
