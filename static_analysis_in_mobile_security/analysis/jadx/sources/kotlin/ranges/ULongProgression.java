...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM5737constructorimpl = ((int) ULong.m5737constructorimpl(j ^ ULong.m5737constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM5737constructorimpl2 = (iM5737constructorimpl + ((int) ULong.m5737constructorimpl(j2 ^ ULong.m5737constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM5737constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m5783toStringimpl(this.first)).append("..").append((Object) ULong.m5783toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m5783toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m5783toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
