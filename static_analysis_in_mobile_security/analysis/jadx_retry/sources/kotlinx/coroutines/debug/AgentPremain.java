...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM5563constructorimpl = Result.m5563constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5563constructorimpl = Result.m5563constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5569isFailureimpl(objM5563constructorimpl) ? null : objM5563constructorimpl);
