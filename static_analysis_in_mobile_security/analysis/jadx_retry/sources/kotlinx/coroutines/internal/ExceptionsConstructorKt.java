                ...
                if (iterator$iv.hasNext()) {
                    ...
                    if (iterator$iv.hasNext()) {
                        ...
                        do {
                            ...
                            Pair p1 = (Pair) e$iv;
                            int v$iv = ((Number) p1.getSecond()).intValue();
                            if (maxValue$iv < v$iv) {
                                maxValue$iv = v$iv;
                                maxElem$iv = e$iv;
                            }
            ...
            switch (parameterTypes.length) {
                ...
                case 1:
                    ...
                    if (!Intrinsics.areEqual(cls2, String.class)) {
                        pair = !Intrinsics.areEqual(cls2, Throwable.class) ? TuplesKt.to(null, -1) : TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    Throwable result = function2.invoke(e);
