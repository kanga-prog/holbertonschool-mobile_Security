...
public final class LockFreeTaskQueueCore<E> {
        ...
        while (true) {
            ...
            if (!this.singleConsumer && this.array.get(tail$iv & mask) != null) {
                ...
                if (_state$FU.compareAndSet(this, state, INSTANCE.updateTail(state, newTail))) {
                    ...
                    while ((_state$FU.get(lockFreeTaskQueueCore) & FROZEN_MASK) != 0 && (lockFreeTaskQueueCoreFillPlaceholder = lockFreeTaskQueueCore.next().fillPlaceholder(tail$iv, element)) != null) {
    ...
    public final Object removeFirstOrNull() {
        ...
        while (true) {
            ...
            int i = this.mask;
            atomicfu$handler$iv = atomicfu$handler$iv;
