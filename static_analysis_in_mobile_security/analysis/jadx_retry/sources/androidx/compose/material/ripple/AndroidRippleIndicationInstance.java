...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        if (Float.isNaN($this$isUnspecified$iv)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m1292getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo3442getSizeNHjbRc()));
        } else {
            iRoundToInt = $this$drawIndication.mo321roundToPx0680j_4(this.radius);
        }
