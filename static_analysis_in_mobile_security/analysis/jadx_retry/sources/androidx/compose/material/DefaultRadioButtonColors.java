...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public State<Color> radioColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m68animateColorAsStateeuL9pac(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, $composer, 48, 12);
