...
public final class TabRowDefaults {
    ...
    public final void m1234Divider9IZ8Weo(Modifier modifier, float thickness, long color, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    $dirty &= -897;
                    color2 = Color.m2969copywmQWz5c(jM2981unboximpl, (14 & 1) != 0 ? Color.m2973getAlphaimpl(jM2981unboximpl) : 0.12f, (14 & 2) != 0 ? Color.m2977getRedimpl(jM2981unboximpl) : 0.0f, (14 & 4) != 0 ? Color.m2976getGreenimpl(jM2981unboximpl) : 0.0f, (14 & 8) != 0 ? Color.m2974getBlueimpl(jM2981unboximpl) : 0.0f);
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Divider$1
            ...
            public final void invoke(Composer composer, int i5) {
                this.$tmp0_rcvr.m1234Divider9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public final void m1235Indicator9IZ8Weo(Modifier modifier, float height, long color, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $dirty &= -897;
                    color2 = ((Color) objConsume).m2981unboximpl();
                }
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Indicator$1
            ...
            public final void invoke(Composer composer, int i5) {
                this.$tmp0_rcvr.m1235Indicator9IZ8Weo(modifier5, f2, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
