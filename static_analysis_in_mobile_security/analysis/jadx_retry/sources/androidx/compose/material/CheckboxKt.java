...
public final class CheckboxKt {
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                companionM727triStateToggleableO2vRcR0 = ToggleableKt.m727triStateToggleableO2vRcR0(Modifier.INSTANCE, state, interactionSource3, RippleKt.m1298rememberRipple9IZ8Weo(false, CheckboxRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m4603boximpl(Role.INSTANCE.m4611getCheckboxo7Vup1c()), function0);
            } else {
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m487padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (($dirty3 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    final State<Color> stateCheckmarkColor = colors.checkmarkColor(value, $composer2, (($dirty3 >> 3) & 14) | (($dirty3 >> 6) & 112));
                    final State<Color> stateBoxColor = colors.boxColor(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    final State<Color> stateBorderColor = colors.borderColor(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    ...
                    if (invalid$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                CheckboxKt.m1029drawBox1wkBAMs(Canvas, CheckboxKt.CheckboxImpl$lambda$9(stateBoxColor), CheckboxKt.CheckboxImpl$lambda$10(stateBorderColor), Canvas.mo327toPx0680j_4(CheckboxKt.RadiusSize), strokeWidthPx);
                                CheckboxKt.m1030drawCheck3IgeMak(Canvas, CheckboxKt.CheckboxImpl$lambda$8(stateCheckmarkColor), CheckboxKt.CheckboxImpl$lambda$4(checkDrawFraction$delegate), CheckboxKt.CheckboxImpl$lambda$6(checkCenterGravitationShiftFraction$delegate), strokeWidthPx, checkCache);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    } else {
