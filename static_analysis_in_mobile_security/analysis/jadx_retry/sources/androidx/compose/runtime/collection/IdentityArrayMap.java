...
public final class IdentityArrayMap<Key, Value> {
    ...
    public final void set(Key key, Value value) {
        ...
        ArraysKt.copyInto(keys, destKeys, insertIndex + 1, insertIndex, size);
        if (resize) {
            ArraysKt.copyInto$default(keys, destKeys, 0, 0, insertIndex, 6, (Object) null);
        }
        ...
        ArraysKt.copyInto(values, destValues, insertIndex + 1, insertIndex, size);
        if (resize) {
            ArraysKt.copyInto$default(values, destValues, 0, 0, insertIndex, 6, (Object) null);
        }
