...
final class Pending {
    ...
    public Pending(List<KeyInfo> keyInfos, int startIndex) {
        ...
        for (int index = 0; index < size; index++) {
            ...
            map.put(Integer.valueOf(keyInfo.getLocation()), new GroupInfo(index, runningNodeIndex, keyInfo.getNodes()));
    ...
    public final KeyInfo getNext(int key, Object dataKey) {
        ...
        return (KeyInfo) ComposerKt.pop(getKeyMap(), joinedKey);
    }
    ...
    public final void registerMoveSlot(int from, int to) {
        if (from > to) {
            Iterable iterableValues = this.groupInfos.values();
            Intrinsics.checkNotNullExpressionValue(iterableValues, "groupInfos.values");
        ...
        if (to > from) {
            Iterable iterableValues2 = this.groupInfos.values();
            Intrinsics.checkNotNullExpressionValue(iterableValues2, "groupInfos.values");
            Iterable $this$forEach$iv2 = iterableValues2;
