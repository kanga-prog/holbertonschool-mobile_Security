...
public final class CompositionLocalMapKt {
    ...
    public static final PersistentCompositionLocalMap mutate(PersistentCompositionLocalMap $this$mutate, Function1<? super Map<CompositionLocal<Object>, State<Object>>, Unit> mutator) {
        ...
        PersistentMap.Builder<CompositionLocal<Object>, State<? extends Object>> builderBuilder2 = $this$mutate.builder2();
    ...
    public static final PersistentCompositionLocalMap compositionLocalMapOf(ProvidedValue<?>[] providedValueArr, PersistentCompositionLocalMap parentScope, Composer $composer, int $changed) {
        ...
        PersistentMap.Builder<CompositionLocal<Object>, State<? extends Object>> builderBuilder2 = result.builder2();
        PersistentMap.Builder<CompositionLocal<Object>, State<? extends Object>> it = builderBuilder2;
        int length = values.length;
        int i = 0;
        while (i < length) {
            ProvidedValue<?> providedValue = values[i];
            ...
            if (providedValue.getCanOverride() || !contains(parentScope, providedValue.getCompositionLocal())) {
                ...
                it.put(compositionLocal, providedValue.getCompositionLocal().provided$runtime_release(providedValue.getValue(), $composer, 8));
            }
