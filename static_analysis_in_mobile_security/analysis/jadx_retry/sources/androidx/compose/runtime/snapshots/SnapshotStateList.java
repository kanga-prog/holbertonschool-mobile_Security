...
public final class SnapshotStateList<T> implements List<T>, StateObject, KMutableList {
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    ...
                    StateListStateRecord $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv, snapshotStateList2, current);
                    ...
                    synchronized (lock$iv$iv2) {
                        try {
                            if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() == currentModification$iv) {
                                try {
                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setList$runtime_release(persistentListAdd);
                                    z = true;
                ...
                try {
                    ...
                    synchronized (lock$iv$iv2) {
                        try {
                            if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() == currentModification$iv) {
                                try {
                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setList$runtime_release(persistentListRemove);
                                    z = true;
                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setModification$runtime_release($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() + 1);
                                } catch (Throwable th2) {
                                    th = th2;
    ...
    public T removeAt(int index) throws Throwable {
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv) {
                Object it2 = it;
                try {
                    StateRecord it3 = snapshotStateList3.getFirstStateRecord();
                    int i2 = i;
                    try {
    ...
    */
    public final void removeRange(int fromIndex, int toIndex) {
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    Snapshot current = Snapshot.INSTANCE.getCurrent();
                    StateListStateRecord $this$mutate_u24lambda_u2418$iv = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv, snapshotStateList2, current);
                    Object lock$iv$iv2 = SnapshotStateListKt.sync;
                    synchronized (lock$iv$iv2) {
                        try {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final void update(Function1<? super PersistentList<? extends T>, ? extends PersistentList<? extends T>> block) throws Throwable {
        int currentModification$iv;
        Object oldList$iv;
        boolean z;
        int $i$f$update = 0;
        ...
        while (true) {
            ...
            PersistentList<? extends T> persistentListInvoke = block.invoke(oldList$iv);
                        ...
                        try {
                            ...
                            synchronized (lock$iv$iv2) {
                                try {
                                    if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() == currentModification$iv) {
                                        try {
                                            $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setList$runtime_release(persistentListInvoke);
                                            $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.setModification$runtime_release($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422$iv.getModification() + 1);
                                            z = true;
                                        } catch (Throwable th2) {
                                            th = th2;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final boolean conditionalUpdate(Function1<? super PersistentList<? extends T>, ? extends PersistentList<? extends T>> block) throws Throwable {
        int currentModification;
        Object oldList;
        int i;
        ...
        while (true) {
            ...
            PersistentList<? extends T> persistentListInvoke = block.invoke(oldList);
            ...
            synchronized (lock$iv$iv$iv$iv) {
                try {
                    ...
                    StateListStateRecord $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422 = (StateListStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv, snapshotStateList, current2);
                    Object lock$iv2 = SnapshotStateListKt.sync;
                    synchronized (lock$iv2) {
                        try {
                            if ($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422.getModification() == currentModification) {
                                try {
                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422.setList$runtime_release(persistentListInvoke);
                                    $this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422.setModification$runtime_release($this$conditionalUpdate_u24lambda_u2423_u24lambda_u2422.getModification() + 1);
                                    i = 1;
                                } catch (Throwable th2) {
                                    th = th2;
                                    try {
