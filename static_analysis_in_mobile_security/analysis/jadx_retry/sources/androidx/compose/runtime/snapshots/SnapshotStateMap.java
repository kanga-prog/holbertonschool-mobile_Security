...
public final class SnapshotStateMap<K, V> implements Map<K, V>, StateObject, KMutableMap {
    ...
    public V put(K key, V value) throws Throwable {
        ...
        while (true) {
            ...
            synchronized (lock$iv$iv) {
                try {
                    StateRecord firstStateRecord = snapshotStateMap.getFirstStateRecord();
                    Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
                    StateRecord $this$withCurrent$iv$iv$iv = (StateMapStateRecord) firstStateRecord;
            ...
            SnapshotStateMap<K, V> snapshotStateMap2 = snapshotStateMap;
            StateRecord firstStateRecord2 = snapshotStateMap2.getFirstStateRecord();
            Intrinsics.checkNotNull(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
            StateRecord $this$writable$iv$iv$iv = (StateMapStateRecord) firstStateRecord2;
            SnapshotKt.getSnapshotInitializer();
            Object lock$iv$iv$iv$iv$iv = SnapshotKt.getLock();
            synchronized (lock$iv$iv$iv$iv$iv) {
                try {
                    Snapshot current = Snapshot.INSTANCE.getCurrent();
                    StateMapStateRecord $this$mutate_u24lambda_u2411$iv = (StateMapStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv, snapshotStateMap2, current);
                    ...
                    synchronized (lock$iv$iv2) {
                        try {
                            ...
                            try {
                                SnapshotKt.notifyWrite(current, snapshotStateMap2);
                                if (z) {
                                    break;
                                }
    ...
    public final boolean removeValue$runtime_release(V value) throws Throwable {
        ...
        do {
            ...
            element$iv = it.next();
        } while (!Intrinsics.areEqual(((Map.Entry) element$iv).getValue(), value));
