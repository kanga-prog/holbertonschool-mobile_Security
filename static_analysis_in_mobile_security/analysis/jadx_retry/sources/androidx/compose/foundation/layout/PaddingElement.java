...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    private PaddingElement(float start, float top, float end, float bottom, boolean rtlAware, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if (start >= 0.0f || Dp.m5279equalsimpl0(start, Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM())) {
            float f = this.top;
            if (f >= 0.0f || Dp.m5279equalsimpl0(f, Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM())) {
                float f2 = this.end;
                if (f2 >= 0.0f || Dp.m5279equalsimpl0(f2, Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM())) {
                    float f3 = this.bottom;
                    if (f3 >= 0.0f || Dp.m5279equalsimpl0(f3, Dp.INSTANCE.m5294getUnspecifiedD9Ej5fM())) {
                        z = true;
                    } else {
                        z = false;
                    }
