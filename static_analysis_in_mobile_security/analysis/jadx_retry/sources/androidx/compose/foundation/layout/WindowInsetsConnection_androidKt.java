...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final NestedScrollConnection m557rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int side, Composer $composer, int $changed) {
        Object value$iv$iv;
        ...
        SideCalculator sideCalculator = SideCalculator.INSTANCE.m517chooseCalculatorni1skBw(side, layoutDirection);
