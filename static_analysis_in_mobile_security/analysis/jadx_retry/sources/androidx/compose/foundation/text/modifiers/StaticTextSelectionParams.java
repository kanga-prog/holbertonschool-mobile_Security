...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow textOverflowM5171boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m5171boximpl(layoutInput.getOverflow());
        int iM5183getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m5183getVisiblegIe3tQ8();
        if (textOverflowM5171boximpl == null) {
            return false;
        }
        return TextOverflow.m5174equalsimpl0(textOverflowM5171boximpl.getValue(), iM5183getVisiblegIe3tQ8);
    }
