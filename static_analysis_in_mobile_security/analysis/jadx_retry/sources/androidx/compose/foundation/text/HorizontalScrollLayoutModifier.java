...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo37measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        if (maxIntrinsicWidth >= Constraints.m5218getMaxWidthimpl(constraints)) {
            jM5208copyZbe2FdA = Constraints.m5208copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : 0, (11 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (11 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : 0, (11 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : 0);
        } else {
            jM5208copyZbe2FdA = constraints;
        }
        long childConstraints = jM5208copyZbe2FdA;
