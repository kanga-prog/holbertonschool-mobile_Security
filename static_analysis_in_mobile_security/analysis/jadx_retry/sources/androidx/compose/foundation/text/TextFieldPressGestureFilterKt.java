            ...
            static final class AnonymousClass2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
                ...
                static final class C00291 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                case 0:
                                    ...
                                    c00301 = this;
                                    PressInteraction.Press oldValue = c00301.$pressedInteraction.getValue();
                                    if (oldValue != null) {
                                        MutableInteractionSource mutableInteractionSource2 = c00301.$interactionSource;
                                        mutableState = c00301.$pressedInteraction;
                                        PressInteraction.Cancel interaction3 = new PressInteraction.Cancel(oldValue);
                                        if (mutableInteractionSource2 != null) {
                                            c00301.L$0 = mutableState;
                                            c00301.label = 1;
                                            if (mutableInteractionSource2.emit(interaction3, c00301) != coroutine_suspended) {
                                        ...
                                        mutableState.setValue(null);
                                        interaction = new PressInteraction.Press(c00301.$it, null);
                                        mutableInteractionSource = c00301.$interactionSource;
                                        if (mutableInteractionSource != null) {
                                            c00301.L$0 = interaction;
                                            c00301.label = 2;
                                            if (mutableInteractionSource.emit(interaction, c00301) != coroutine_suspended) {
                                                c00302 = c00301;
                                    ...
                                    c00301.$pressedInteraction.setValue(interaction);
                                    return Unit.INSTANCE;
                                case 1:
                                    c00301 = this;
                                    i = 0;
                                    mutableState2 = (MutableState) c00301.L$0;
                                    ResultKt.throwOnFailure($result);
                                    mutableState = mutableState2;
                                    mutableState.setValue(null);
                                    interaction = new PressInteraction.Press(c00301.$it, null);
                                ...
                                case 2:
                                    c00302 = this;
                                    interaction2 = (PressInteraction.Press) c00302.L$0;
                                    ResultKt.throwOnFailure($result);
                                    interaction = interaction2;
                                    c00301 = c00302;
                                    c00301.$pressedInteraction.setValue(interaction);
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                ...
                                case 1:
                                    c00312 = this;
                                    c00313 = null;
                                    mutableState2 = (MutableState) c00312.L$0;
                                    ResultKt.throwOnFailure($result);
                                    mutableState = mutableState2;
                                    mutableState.setValue(null);
                                    return Unit.INSTANCE;
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        BuildersKt__Builders_commonKt.launch$default(c00291.$scope, null, null, new C00312(c00291.$pressedInteraction, success, c00291.$interactionSource, null), 3, null);
                        return Unit.INSTANCE;
                    }
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            this.label = 1;
                            if (TapGestureDetectorKt.detectTapAndPress($this$pointerInput, c00291, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.tapPressTextFieldModifier.1.2.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(1);
