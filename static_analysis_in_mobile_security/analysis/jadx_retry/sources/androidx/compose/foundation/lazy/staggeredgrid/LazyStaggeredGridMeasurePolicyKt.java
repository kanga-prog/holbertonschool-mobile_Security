        ...
        if (invalid$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final LazyStaggeredGridMeasureResult m681invoke0kLqBqw(LazyLayoutMeasureScope $this$null, long constraints) {
                    ...
                    int beforeContentPadding = $this$null.mo321roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(contentPadding, orientation, reverseLayout, $this$null.getLayoutDirection()));
                    int afterContentPadding = $this$null.mo321roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(contentPadding, orientation, reverseLayout, $this$null.getLayoutDirection()));
                    int startContentPadding = $this$null.mo321roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(contentPadding, orientation, $this$null.getLayoutDirection()));
                    ...
                    int iM5232constrainWidthK40F9xA = ConstraintsKt.m5232constrainWidthK40F9xA(constraints, horizontalPadding);
                    int horizontalPadding2 = ConstraintsKt.m5231constrainHeightK40F9xA(constraints, verticalPadding);
                    LazyStaggeredGridMeasureResult it = LazyStaggeredGridMeasureKt.m679measureStaggeredGriddSVRQoE($this$null, state, listCalculateLazyLayoutPinnedIndices, itemProvider, resolvedSlots, Constraints.m5208copyZbe2FdA(constraints, (11 & 1) != 0 ? Constraints.m5220getMinWidthimpl(constraints) : iM5232constrainWidthK40F9xA, (11 & 2) != 0 ? Constraints.m5218getMaxWidthimpl(constraints) : 0, (11 & 4) != 0 ? Constraints.m5219getMinHeightimpl(constraints) : horizontalPadding2, (11 & 8) != 0 ? Constraints.m5217getMaxHeightimpl(constraints) : 0), isVertical, reverseLayout, contentOffset, mainAxisAvailableSize, $this$null.mo321roundToPx0680j_4(mainAxisSpacing), beforeContentPadding, afterContentPadding);
