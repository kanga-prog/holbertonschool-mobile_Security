...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i = 0; i < lineItemsCount; i++) {
            ...
            LazyGridMeasuredItem lazyGridMeasuredItemM626getAndMeasure3p2s80s = this.measuredItemProvider.m626getAndMeasure3p2s80s(lineConfiguration.getFirstItemIndex() + i, mainAxisSpacing, constraints);
            startSlot += span;
            Unit unit = Unit.INSTANCE;
            items[i] = lazyGridMeasuredItemM626getAndMeasure3p2s80s;
        }
