    ...
    public static final void LazyLayoutPrefetcher(final LazyLayoutPrefetchState prefetchState, final LazyLayoutItemContentFactory itemContentFactory, final SubcomposeLayoutState subcomposeLayoutState, Composer $composer, final int $changed) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutPrefetcher_androidKt.LazyLayoutPrefetcher.2
            ...
            public final void invoke(Composer composer, int i2) {
                LazyLayoutPrefetcher_androidKt.LazyLayoutPrefetcher(prefetchState, itemContentFactory, subcomposeLayoutState, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
}
