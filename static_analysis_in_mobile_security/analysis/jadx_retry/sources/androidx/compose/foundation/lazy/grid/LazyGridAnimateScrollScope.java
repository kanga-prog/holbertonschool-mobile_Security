        ...
        while (lineStartIndex < visibleItemsInfo.size()) {
            ...
            if (currentLine == -1) {
                ...
                while (lineEndIndex < visibleItemsInfo.size() && function1.invoke(Integer.valueOf(lineEndIndex)).intValue() == currentLine) {
                    if (isVertical) {
                        iM5434getWidthimpl = IntSize.m5433getHeightimpl(visibleItemsInfo.get(lineEndIndex).getSize());
                    } else {
                        iM5434getWidthimpl = IntSize.m5434getWidthimpl(visibleItemsInfo.get(lineEndIndex).getSize());
                    }
                    lineMainAxisSize = Math.max(lineMainAxisSize, iM5434getWidthimpl);
                    lineEndIndex++;
                }
