                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        if (active$iv) {
                            ...
                            LazyLayoutItemContentFactoryKt.m642SkippableItemJVlU9Rs(itemProvider, StableValue.m658constructorimpl(lazyLayoutItemContentFactory2.saveableStateHolder), index, StableValue.m658constructorimpl(cachedItemContent.getKey()), $composer, 0);
