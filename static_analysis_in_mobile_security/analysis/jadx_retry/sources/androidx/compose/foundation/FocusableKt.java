...
public final class FocusableKt {
    ...
    public static final Modifier focusable(Modifier $this$focusable, boolean enabled, MutableInteractionSource interactionSource) {
        ...
        if (enabled) {
            companionFocusTarget = FocusModifierKt.focusTarget(new FocusableElement(interactionSource));
        } else {
            companionFocusTarget = Modifier.INSTANCE;
        }
        return $this$focusable.then(companionFocusTarget);
    }
    ...
    public static final Modifier focusableInNonTouchMode(Modifier $this$focusableInNonTouchMode, final boolean enabled, final MutableInteractionSource interactionSource) {
        ...
        return InspectableValueKt.inspectableWrapper($this$focusableInNonTouchMode, function1, $this$focusableInNonTouchMode_u24lambda_u241);
    }
}
