...
public final class BadgeKt {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "anchor")) {
                                    ...
                                    return Layout.layout(totalWidth, totalHeight, MapsKt.mapOf(TuplesKt.to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(firstBaseline)), TuplesKt.to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(lastBaseline))), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.BadgeKt$BadgedBox$2$measure$1
                                        ...
                                        public final void invoke2(Placeable.PlacementScope layout) {
                                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                                            boolean hasContent = badgePlaceable.getWidth() > Layout.mo321roundToPx0680j_4(BadgeTokens.INSTANCE.m2025getSizeD9Ej5fM());
                                            ...
                                            int badgeY = ((-badgePlaceable.getHeight()) / 2) + Layout.mo321roundToPx0680j_4(badgeVerticalOffset);
    ...
    public static final void m1322BadgeeopBjH0(Modifier modifier, long containerColor, long contentColor, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            float size = function4 != null ? badgeTokens.m2024getLargeSizeD9Ej5fM() : badgeTokens.m2025getSizeD9Ej5fM();
            if (function4 != null) {
            ...
            Modifier modifierThen = ClipKt.clip(BackgroundKt.m159backgroundbw27NRU(SizeKt.m518defaultMinSizeVpY3zN4(modifier3, size, size), containerColor2, shape), shape).then(function4 != null ? PaddingKt.m489paddingVpY3zN4$default(Modifier.INSTANCE, BadgeWithContentHorizontalPadding, 0.0f, 2, null) : Modifier.INSTANCE);
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BadgeKt$Badge$2
            ...
            public final void invoke(Composer composer, int i7) {
                BadgeKt.m1322BadgeeopBjH0(modifier5, j2, j3, function6, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
