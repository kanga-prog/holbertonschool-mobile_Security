...
final class SwipeAnchorsModifierImpl extends InspectorValueInfo implements LayoutModifier, OnRemeasuredModifier {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        if (measure.getDensity() == this.lastDensity) {
            if (!(measure.getFontScale() == this.lastFontScale)) {
        ...
        return MeasureScope.CC.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SwipeAnchorsModifier$measure$1
            {
                super(1);
            }
