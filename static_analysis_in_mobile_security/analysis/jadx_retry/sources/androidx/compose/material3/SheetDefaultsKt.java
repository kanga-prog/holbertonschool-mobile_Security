...
public final class SheetDefaultsKt {
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection.1
            ...
            public Object mo336onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
                ...
                if (toFling < 0.0f && currentOffset > sheetState.getSwipeableState$material3_release().getMinOffset()) {
                    ...
                    jM5510getZero9UxMQ8M = available;
                } else {
    ...
    public static final SheetState rememberSheetState(boolean skipPartiallyExpanded, Function1<? super SheetValue, Boolean> function1, SheetValue initialValue, boolean skipHiddenState, Composer $composer, int $changed, int i) {
        ...
        final Function1<? super SheetValue, Boolean> function2 = (i & 2) != 0 ? new Function1<SheetValue, Boolean>() { // from class: androidx.compose.material3.SheetDefaultsKt.rememberSheetState.1
        ...
        Object[] objArr = {Boolean.valueOf(skipPartiallyExpanded2), function2};
        Saver<SheetState, SheetValue> Saver = SheetState.INSTANCE.Saver(skipPartiallyExpanded2, function2);
        Object[] keys$iv = {Boolean.valueOf(skipPartiallyExpanded2), initialValue2, function2, Boolean.valueOf(skipHiddenState2)};
        ...
        if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            value$iv$iv = (Function0) new Function0<SheetState>() { // from class: androidx.compose.material3.SheetDefaultsKt$rememberSheetState$2$1
                ...
                public final SheetState invoke() {
                    return new SheetState(skipPartiallyExpanded2, initialValue2, function2, skipHiddenState2);
                }
            };
