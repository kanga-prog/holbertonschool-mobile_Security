...
public final class CheckboxKt {
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        CheckboxColors colors3;
        Object value$iv$iv;
        Modifier.Companion companionM727triStateToggleableO2vRcR0;
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            if (function0 != null) {
                ...
                companionM727triStateToggleableO2vRcR0 = ToggleableKt.m727triStateToggleableO2vRcR0(companion, state, interactionSource2, RippleKt.m1298rememberRipple9IZ8Weo(false, Dp.m5274constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4), enabled2, Role.m4603boximpl(iM4611getCheckboxo7Vup1c), function0);
            } else {
                companionM727triStateToggleableO2vRcR0 = Modifier.INSTANCE;
            }
            $composer2.endReplaceableGroup();
            Modifier toggleableModifier = companionM727triStateToggleableO2vRcR0;
            CheckboxImpl(enabled2, state, PaddingKt.m487padding3ABfNKs(modifier3.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.INSTANCE) : Modifier.INSTANCE).then(toggleableModifier), CheckboxDefaultPadding), colors3, $composer2, (($dirty >> 9) & 14) | (($dirty << 3) & 112) | (($dirty >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (($dirty3 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[it4.ordinal()]) {
                ...
                case 2:
                    ...
                    final State<Color> stateCheckmarkColor$material3_release = colors.checkmarkColor$material3_release(value, $composer2, (($dirty3 >> 3) & 14) | (($dirty3 >> 6) & 112));
                    final State<Color> stateBoxColor$material3_release = colors.boxColor$material3_release(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    final State<Color> stateBorderColor$material3_release = colors.borderColor$material3_release(enabled, value, $composer2, ($dirty3 & 14) | ($dirty3 & 112) | (($dirty3 >> 3) & 896));
                    Modifier modifierM526requiredSize3ABfNKs = SizeKt.m526requiredSize3ABfNKs(SizeKt.wrapContentSize$default(modifier, Alignment.INSTANCE.getCenter(), false, 2, null), CheckboxSize);
                    ...
                    if (invalid$iv || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                        value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$1$1
                            ...
                            public final void invoke2(DrawScope Canvas) {
                                ...
                                float strokeWidthPx = (float) Math.floor(Canvas.mo327toPx0680j_4(CheckboxKt.StrokeWidth));
                                CheckboxKt.m1355drawBox1wkBAMs(Canvas, stateBoxColor$material3_release.getValue().m2981unboximpl(), stateBorderColor$material3_release.getValue().m2981unboximpl(), Canvas.mo327toPx0680j_4(CheckboxKt.RadiusSize), strokeWidthPx);
                                CheckboxKt.m1356drawCheck3IgeMak(Canvas, stateCheckmarkColor$material3_release.getValue().m2981unboximpl(), checkDrawFraction.getValue().floatValue(), checkCenterGravitationShiftFraction.getValue().floatValue(), strokeWidthPx, checkCache);
                            }
                        };
                        $composer2.updateRememberedValue(value$iv$iv2);
                    } else {
