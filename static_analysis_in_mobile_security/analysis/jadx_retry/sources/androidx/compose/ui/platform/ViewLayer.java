...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public void mo4494updateLayerPropertiesdDxrwY(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy, LayoutDirection layoutDirection, Density density) {
        ...
        setPivotX(TransformOrigin.m3357getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m3358getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        setCameraDistancePx(cameraDistance);
        this.clipToBounds = clip && shape == RectangleShapeKt.getRectangleShape();
        resetClipBounds();
        boolean wasClippingManually3 = getManualClipPath() != null;
        if (clip) {
            wasClippingManually = wasClippingManually3;
            boolean wasClippingManually4 = shape != RectangleShapeKt.getRectangleShape();
            setClipToOutline(wasClippingManually4);
            wasClippingManually2 = wasClippingManually;
            boolean shapeChanged = this.outlineResolver.update(shape, getAlpha(), getClipToOutline(), getElevation(), layoutDirection, density);
            updateOutlineResolver();
            if (getManualClipPath() != null) {
                isClippingManually = true;
            } else {
                isClippingManually = false;
            }
            if (wasClippingManually2 == isClippingManually || (isClippingManually && shapeChanged)) {
                invalidate();
            }
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m3025toArgb8_81llA(ambientShadowColor));
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m3025toArgb8_81llA(spotShadowColor));
            }
            if (Build.VERSION.SDK_INT >= 31) {
                ViewLayerVerificationHelper31.INSTANCE.setRenderEffect(this, renderEffect);
            }
            if (CompositingStrategy.m3051equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3057getOffscreenNrFUSI())) {
                setLayerType(2, null);
                z = true;
            } else if (CompositingStrategy.m3051equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3056getModulateAlphaNrFUSI())) {
                z = false;
                setLayerType(0, null);
            } else {
                setLayerType(0, null);
        ...
        setClipToOutline(wasClippingManually4);
        wasClippingManually2 = wasClippingManually;
        boolean shapeChanged2 = this.outlineResolver.update(shape, getAlpha(), getClipToOutline(), getElevation(), layoutDirection, density);
        updateOutlineResolver();
        if (getManualClipPath() != null) {
            isClippingManually = true;
        } else {
        ...
        if (wasClippingManually2 == isClippingManually) {
            invalidate();
        } else {
            invalidate();
        }
    ...
    public long mo4490mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM4559calculateInverseMatrixbWbORWo = this.matrixCache.m4559calculateInverseMatrixbWbORWo(this);
            return fArrM4559calculateInverseMatrixbWbORWo != null ? androidx.compose.ui.graphics.Matrix.m3208mapMKHz9U(fArrM4559calculateInverseMatrixbWbORWo, point) : Offset.INSTANCE.m2745getInfiniteF1C5BW0();
        }
