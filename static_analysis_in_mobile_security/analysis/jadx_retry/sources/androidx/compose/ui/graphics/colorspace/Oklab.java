...
public final class Oklab extends ColorSpace {
    ...
    public long mo3388xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
        ...
        float v3 = Math.signum(v0) * ((float) Math.pow(Math.abs(v0), d));
        float v4 = Math.signum(v1) * ((float) Math.pow(Math.abs(v1), d));
        float v5 = Math.signum(v2) * ((float) Math.pow(Math.abs(v2), d));
        float[] fArr2 = M2;
        float v01 = ColorSpaceKt.mul3x3Float3_0(fArr2, v3, v4, v5);
        float v11 = ColorSpaceKt.mul3x3Float3_1(fArr2, v3, v4, v5);
        float v21 = ColorSpaceKt.mul3x3Float3_2(fArr2, v3, v4, v5);
