...
public final class RenderIntent {
    ...
    public static String m3401toStringimpl(int arg0) {
        if (m3399equalsimpl0(arg0, Perceptual)) {
            return "Perceptual";
        }
        if (m3399equalsimpl0(arg0, Relative)) {
            return "Relative";
        }
        if (m3399equalsimpl0(arg0, Saturation)) {
            return "Saturation";
        }
        return m3399equalsimpl0(arg0, Absolute) ? "Absolute" : "Unknown";
    }
