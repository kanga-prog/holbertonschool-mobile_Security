...
public final class CanvasDrawScope implements DrawScope {
    ...
    static /* synthetic */ Paint m3415configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        int iM3526getDefaultFilterQualityfv9h1I;
        if ((i3 & 32) == 0) {
            iM3526getDefaultFilterQualityfv9h1I = i2;
        } else {
            iM3526getDefaultFilterQualityfv9h1I = DrawScope.INSTANCE.m3526getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3414configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, iM3526getDefaultFilterQualityfv9h1I);
    }
    ...
    static /* synthetic */ Paint m3413configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        ...
        return canvasDrawScope.m3412configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, iM3526getDefaultFilterQualityfv9h1I);
    }
    ...
    static /* synthetic */ Paint m3417configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        int iM3526getDefaultFilterQualityfv9h1I;
        if ((i5 & 512) == 0) {
            iM3526getDefaultFilterQualityfv9h1I = i4;
        } else {
            iM3526getDefaultFilterQualityfv9h1I = DrawScope.INSTANCE.m3526getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3416configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, iM3526getDefaultFilterQualityfv9h1I);
    }
    ...
    static /* synthetic */ Paint m3419configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        ...
        return canvasDrawScope.m3418configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, iM3526getDefaultFilterQualityfv9h1I);
    }
    ...
    private final long m3420modulate5vOe2sY(long $this$modulate_u2d5vOe2sY, float alpha) {
        if (!(alpha == 1.0f)) {
            return Color.m2969copywmQWz5c($this$modulate_u2d5vOe2sY, (14 & 1) != 0 ? Color.m2973getAlphaimpl($this$modulate_u2d5vOe2sY) : Color.m2973getAlphaimpl($this$modulate_u2d5vOe2sY) * alpha, (14 & 2) != 0 ? Color.m2977getRedimpl($this$modulate_u2d5vOe2sY) : 0.0f, (14 & 4) != 0 ? Color.m2976getGreenimpl($this$modulate_u2d5vOe2sY) : 0.0f, (14 & 8) != 0 ? Color.m2974getBlueimpl($this$modulate_u2d5vOe2sY) : 0.0f);
        }
    ...
    public static final /* data */ class DrawParams {
        ...
        public /* synthetic */ DrawParams(Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? CanvasDrawScopeKt.DefaultDensity : density, (i & 2) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 4) != 0 ? new EmptyCanvas() : canvas, (i & 8) != 0 ? Size.INSTANCE.m2809getZeroNHjbRc() : j, null);
        }
