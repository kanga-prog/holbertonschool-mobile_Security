    ...
    public static final class Companion {
        ...
        public final int nextFloat(String s, int start, int end, FloatResult result) {
            ...
            if (isNegative) {
                ...
                c3 = s.charAt(index);
                char $this$isDigit$iv = ((char) (c3 + 65488)) < '\n' ? (char) 1 : (char) 0;
                if ($this$isDigit$iv == 0 && c3 != '.') {
                    return index;
                }
            }
            long significand4 = 0;
            ...
            while (index != end) {
                char $this$isDigit$iv2 = c3;
                if (!(((char) ($this$isDigit$iv2 + 65488)) < '\n')) {
                    break;
                }
                boolean isNegative2 = isNegative;
                significand4 = (10 * significand4) + ((long) (c3 - '0'));
                index++;
                c3 = index < s.length() ? s.charAt(index) : (char) 0;
            ...
            if ((c | ' ') == 101) {
                index++;
                char c5 = index < s.length() ? s.charAt(index) : (char) 0;
                boolean isExponentNegative = c5 == '-';
                if (isExponentNegative || c5 == '+') {
                    index++;
                }
                c2 = s.charAt(index);
                while (true) {
            ...
            if (digitCount2 > 19) {
                ...
                if (digitCount2 > 19) {
                    ...
                    while (true) {
                        ...
                        if (retryIndex2 == significandEndIndex || Long.compare(ULong.m5737constructorimpl(significand2) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                            break;
                        }
                    ...
                    if (Long.compare(ULong.m5737constructorimpl(significand2) ^ Long.MIN_VALUE, 1000000000000000000L ^ Long.MIN_VALUE) >= 0) {
                        ...
                        while (true) {
                            ...
                            if (Long.compare(ULong.m5737constructorimpl(significand2) ^ Long.MIN_VALUE, j ^ Long.MIN_VALUE) >= 0) {
                                break;
                            }
                            significand2 = (significand2 * 10) + ((long) (c2 - '0'));
                            retryIndex3++;
            ...
            if ((FastFloatParser.FloatMinExponent <= exponent && exponent < 11) && !tooManyDigits2 && Long.compare(ULong.m5737constructorimpl(significand2) ^ Long.MIN_VALUE, ULong.m5737constructorimpl(16777216L) ^ Long.MIN_VALUE) <= 0) {
            ...
            if (significand2 == 0) {
                result.setValid(true);
                result.setValue(isNegative != 0 ? -0.0f : 0.0f);
                return index;
            }
            ...
            long significandFactor = ULongArray.m5797getsVKNKU(FastFloatParser.Mantissa64, exponent + 325);
            ...
            long j2 = isNegative != 0 ? Long.MIN_VALUE : 0L;
            result.setValid(true);
