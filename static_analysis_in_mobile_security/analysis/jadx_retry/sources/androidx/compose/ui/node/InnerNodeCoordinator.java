...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    public void mo4361hitTestChildYqVAtuI(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        boolean inLayer;
        ...
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (m4437withinLayerBoundsk4lQ0M(pointerPosition)) {
                ...
                float f = m4425distanceInMinimumTouchTargettz77jQw(pointerPosition, m4428getMinimumTouchTargetSizeNHjbRc());
            ...
            if (size$iv <= 0) {
                ...
                while (true) {
                    ...
                    if (child.isPlaced()) {
                        depth$iv = depth$iv2;
                        this_$iv = this_$iv2;
                        hitTestSource.mo4438childHitTestYqVAtuI(child, pointerPosition, hitTestResult, isTouchEvent, inLayer);
