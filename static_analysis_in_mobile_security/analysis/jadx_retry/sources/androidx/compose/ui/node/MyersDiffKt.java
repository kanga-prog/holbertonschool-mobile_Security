...
public final class MyersDiffKt {
    private static final IntStack calculateDiff(int oldSize, int newSize, DiffCallback cb) {
        ...
        int[] forward = CenteredArray.m4327constructorimpl(new int[(max * 2) + 1]);
        int[] backward = CenteredArray.m4327constructorimpl(new int[(max * 2) + 1]);
        ...
        while (stack.isNotEmpty()) {
            ...
            forward = forward;
            int[] snake3 = snake2;
            boolean found = m4404midPointq5eDKzI(oldStart, oldEnd, newStart, newEnd, cb, forward, backward, snake2);
            if (!found) {
                snake2 = snake3;
            } else {
                ...
                stack.pushRange(Snake.m4506getEndXimpl(snake), oldEnd, Snake.m4507getEndYimpl(snake), newEnd);
                snake2 = snake;
            }
        }
