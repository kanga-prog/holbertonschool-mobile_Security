...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void drawContent() {
        ...
        this = this;
        LayoutNodeDrawScope $this$drawIntoCanvas$iv2 = this;
        int $i$f$drawIntoCanvas2 = 0;
        Canvas canvas = $this$drawIntoCanvas$iv2.getDrawContext().getCanvas();
        ...
        while (nodePop != null) {
            if (nodePop instanceof DrawModifierNode) {
                ...
                this.performDraw(it, canvas);
                $this$drawIntoCanvas$iv = $this$drawIntoCanvas$iv2;
                $i$f$drawIntoCanvas = $i$f$drawIntoCanvas2;
            } else {
                ...
                if (!((this_$iv$iv.getKindSet() & kind$iv) != 0) || !(nodePop instanceof DelegatingNode)) {
                    ...
                    while (node$iv$iv != null) {
                        ...
                        if (!((next$iv.getKindSet() & kind$iv) != 0)) {
                            $this$drawIntoCanvas$iv2 = $this$drawIntoCanvas$iv2;
                            $i$f$drawIntoCanvas2 = $i$f$drawIntoCanvas2;
                        } else {
                            count$iv++;
                            if (count$iv == i) {
                                nodePop = next$iv;
                    ...
                    $i$f$drawIntoCanvas = $i$f$drawIntoCanvas2;
                    if (count$iv == 1) {
                        $this$drawIntoCanvas$iv2 = $this$drawIntoCanvas$iv;
                        $i$f$drawIntoCanvas2 = $i$f$drawIntoCanvas;
                    }
                }
            }
    ...
    public final void m4378drawx_KDEd0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode) {
        ...
        int kind$iv2 = NodeKind.m4443constructorimpl(4);
        MutableVector mutableVector = null;
