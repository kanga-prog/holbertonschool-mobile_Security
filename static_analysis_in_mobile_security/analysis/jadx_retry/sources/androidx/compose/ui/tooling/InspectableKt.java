...
/* JADX INFO: compiled from: Inspectable.kt */
    ...
    public static final void Inspectable(final CompositionDataRecord compositionDataRecord, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.tooling.InspectableKt.Inspectable.1
            ...
            public final void invoke(Composer composer, int i) {
                InspectableKt.Inspectable(compositionDataRecord, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
