    ...
    public static final class AnimateXAsStateSearch extends Search<AnimateXAsStateSearchInfo<?, ?>> {
        ...
        private final <T> List<AnimateXAsStateSearchInfo<T, AnimationVector>> findAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNullTo$iv$iv) {
                ...
                Animatable animatable = findAnimatable(it);
                List groups2 = groups;
                AnimationSpec<T> animationSpecFindAnimationSpec = findAnimationSpec(it);
                ...
                if (animatable != null && animationSpecFindAnimationSpec != null && toolingOverride != null) {
                    if (toolingOverride.getValue() == null) {
                    ...
                    animateXAsStateSearchInfo = new AnimateXAsStateSearchInfo(animatable, animationSpecFindAnimationSpec, (ToolingState) value);
                }
