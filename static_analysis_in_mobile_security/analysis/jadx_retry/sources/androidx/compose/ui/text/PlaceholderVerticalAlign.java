...
public final class PlaceholderVerticalAlign {
    ...
    public static String m4697toStringimpl(int arg0) {
        if (m4695equalsimpl0(arg0, AboveBaseline)) {
            return "AboveBaseline";
        }
        if (m4695equalsimpl0(arg0, Top)) {
            return "Top";
        }
        if (m4695equalsimpl0(arg0, Bottom)) {
            return "Bottom";
        }
        if (m4695equalsimpl0(arg0, Center)) {
            return "Center";
        }
        if (m4695equalsimpl0(arg0, TextTop)) {
            return "TextTop";
        }
        if (m4695equalsimpl0(arg0, TextBottom)) {
            return "TextBottom";
        }
        return m4695equalsimpl0(arg0, TextCenter) ? "TextCenter" : "Invalid";
    }
