...
public final /* data */ class TypefaceRequest {
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m4868hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m4877hashCodeimpl(this.fontSynthesis)) * 31;
