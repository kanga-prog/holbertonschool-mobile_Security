...
public final class FontFamilyResolver_androidKt {
    ...
    public static final State<android.graphics.Typeface> m4843resolveAsTypefaceWqqsr6A(FontFamily.Resolver resolveAsTypeface, FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        ...
        State stateMo4841resolveDPcqOEQ = resolveAsTypeface.mo4841resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
        Intrinsics.checkNotNull(stateMo4841resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return stateMo4841resolveDPcqOEQ;
    }
}
