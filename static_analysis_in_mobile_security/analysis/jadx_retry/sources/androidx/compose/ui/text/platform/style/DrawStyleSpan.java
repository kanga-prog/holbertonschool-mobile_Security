...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final Paint.Join m5024toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        if (StrokeJoin.m3330equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3335getMiterLxFBmk8())) {
            return Paint.Join.MITER;
        }
        if (StrokeJoin.m3330equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3336getRoundLxFBmk8())) {
            return Paint.Join.ROUND;
        }
        return StrokeJoin.m3330equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.INSTANCE.m3334getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }
    ...
    private final Paint.Cap m5023toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        if (StrokeCap.m3320equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3324getButtKaPHkGw())) {
            return Paint.Cap.BUTT;
        }
        if (StrokeCap.m3320equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3325getRoundKaPHkGw())) {
            return Paint.Cap.ROUND;
        }
        return StrokeCap.m3320equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.INSTANCE.m3326getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
