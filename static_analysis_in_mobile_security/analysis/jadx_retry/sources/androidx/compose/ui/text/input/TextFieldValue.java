...
public final class TextFieldValue {
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM4773getZerod9O1mEE;
        TextRange textRange2;
        if ((i & 2) == 0) {
            jM4773getZerod9O1mEE = j;
        } else {
            jM4773getZerod9O1mEE = TextRange.INSTANCE.m4773getZerod9O1mEE();
        }
        if ((i & 4) == 0) {
        ...
        this(annotatedString, jM4773getZerod9O1mEE, textRange2, (DefaultConstructorMarker) null);
    }
