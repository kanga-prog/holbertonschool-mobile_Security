...
public final class KeyboardCapitalization {
    ...
    public static String m4950toStringimpl(int arg0) {
        if (m4948equalsimpl0(arg0, None)) {
            return "None";
        }
        if (m4948equalsimpl0(arg0, Characters)) {
            return "Characters";
        }
        if (m4948equalsimpl0(arg0, Words)) {
            return "Words";
        }
        return m4948equalsimpl0(arg0, Sentences) ? "Sentences" : "Invalid";
    }
