...
public final class AndroidTextPaint extends TextPaint {
    ...
    */
    public final void m5007setBrush12SF9DM(Brush brush, long size, float alpha) {
        if (brush instanceof SolidColor) {
            long $this$isSpecified$iv = ((SolidColor) brush).getValue();
        ...
        brush.mo2918applyToPq9zytI(size, this.composePaint, Float.isNaN(alpha) ? this.composePaint.getAlpha() : RangesKt.coerceIn(alpha, 0.0f, 1.0f));
    }
