...
public final class AnnotatedString implements CharSequence {
    ...
    public final List<Range<String>> getStringAnnotations(String tag, int start, int end) {
        ...
        if (list != null) {
            ...
            while (index$iv$iv < size) {
                ...
                if ((range2.getItem() instanceof String) && Intrinsics.areEqual(tag2, range2.getTag())) {
                    z = AnnotatedStringKt.intersect(start, end, range2.getStart(), range2.getEnd());
                    if (z) {
                        target$iv.add(range);
                    }
                    index$iv$iv++;
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x0053 A[LOOP:0: B:5:0x0018->B:17:0x0053, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:23:0x0051 A[SYNTHETIC] */
    public final boolean hasStringAnnotations(String tag, int start, int end) {
        ...
        while (index$iv$iv < size) {
            ...
            Range<? extends Object> range = (Range) item$iv$iv;
            if ((range.getItem() instanceof String) && Intrinsics.areEqual(tag2, range.getTag())) {
