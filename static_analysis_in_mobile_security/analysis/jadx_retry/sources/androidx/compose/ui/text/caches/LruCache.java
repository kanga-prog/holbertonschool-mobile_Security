        ...
        while (true) {
            ...
            synchronized (lock$iv) {
                ...
                if (size() > maxSize && !this.map.isEmpty()) {
                    key = CollectionsKt.first(this.keySet);
                    ...
                    TypeIntrinsics.asMutableCollection(this.keySet).remove(key);
                    int size = size();
                    Intrinsics.checkNotNull(key);
                    Intrinsics.checkNotNull(v);
                    this.size = size - safeSizeOf(key, v);
                    this.evictionCount++;
                }
                Unit unit = Unit.INSTANCE;
            }
