...
public final class ConstraintsKt {
    ...
    public static final boolean m5233isSatisfiedBy4WqzIAM(long $this$isSatisfiedBy_u2d4WqzIAM, long size) {
        int iM5220getMinWidthimpl = Constraints.m5220getMinWidthimpl($this$isSatisfiedBy_u2d4WqzIAM);
        int iM5218getMaxWidthimpl = Constraints.m5218getMaxWidthimpl($this$isSatisfiedBy_u2d4WqzIAM);
        int iM5434getWidthimpl = IntSize.m5434getWidthimpl(size);
        if (iM5220getMinWidthimpl <= iM5434getWidthimpl && iM5434getWidthimpl <= iM5218getMaxWidthimpl) {
            int iM5219getMinHeightimpl = Constraints.m5219getMinHeightimpl($this$isSatisfiedBy_u2d4WqzIAM);
            int iM5217getMaxHeightimpl = Constraints.m5217getMaxHeightimpl($this$isSatisfiedBy_u2d4WqzIAM);
            int iM5433getHeightimpl = IntSize.m5433getHeightimpl(size);
            if (iM5219getMinHeightimpl <= iM5433getHeightimpl && iM5433getHeightimpl <= iM5217getMaxHeightimpl) {
                return true;
            }
        }
        return false;
