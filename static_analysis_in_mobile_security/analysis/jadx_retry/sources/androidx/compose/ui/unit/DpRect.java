...
public final /* data */ class DpRect {
    ...
    private DpRect(long origin, long size) {
        float fM5335getXD9Ej5fM = DpOffset.m5335getXD9Ej5fM(origin);
        float fM5337getYD9Ej5fM = DpOffset.m5337getYD9Ej5fM(origin);
        float arg0$iv = DpOffset.m5335getXD9Ej5fM(origin);
        float other$iv = DpSize.m5372getWidthD9Ej5fM(size);
        float other$iv2 = Dp.m5274constructorimpl(arg0$iv + other$iv);
        float arg0$iv2 = DpOffset.m5337getYD9Ej5fM(origin);
        float other$iv3 = DpSize.m5370getHeightD9Ej5fM(size);
        this(fM5335getXD9Ej5fM, fM5337getYD9Ej5fM, other$iv2, Dp.m5274constructorimpl(arg0$iv2 + other$iv3), null);
    }
}
