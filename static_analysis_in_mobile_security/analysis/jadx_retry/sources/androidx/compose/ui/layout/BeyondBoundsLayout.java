...
public interface BeyondBoundsLayout {
    ...
    public static final class LayoutDirection {
        ...
        public static String m4207toStringimpl(int arg0) {
            if (m4205equalsimpl0(arg0, Before)) {
                return "Before";
            }
            if (m4205equalsimpl0(arg0, After)) {
                return "After";
            }
            if (m4205equalsimpl0(arg0, Left)) {
                return "Left";
            }
            if (m4205equalsimpl0(arg0, Right)) {
                return "Right";
            }
            if (m4205equalsimpl0(arg0, Above)) {
                return "Above";
            }
            return m4205equalsimpl0(arg0, Below) ? "Below" : "invalid LayoutDirection";
        }
