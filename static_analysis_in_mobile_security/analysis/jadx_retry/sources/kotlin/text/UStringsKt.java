...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5658constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m5658constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        while (i2 < length) {
            ...
            result = ULong.m5737constructorimpl(ULong.m5737constructorimpl(((long) UInt.m5658constructorimpl(digit)) & 4294967295L) + result2);
