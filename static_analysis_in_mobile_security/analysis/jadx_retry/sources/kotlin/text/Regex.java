        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c06061 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c06061.L$0;
                    matcher = Regex.this.nativePattern.matcher(c06061.$input);
                    if (c06061.$limit == 1 || !matcher.find()) {
                        c06061.label = 1;
                        return $this$sequence2.yield(c06061.$input.toString(), c06061) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c06061.L$0 = $this$sequence;
                    c06061.L$1 = matcher;
                    c06061.I$0 = splitCount;
                    c06061.label = 2;
                    if ($this$sequence.yield(c06061.$input.subSequence(nextStart, matcher.start()).toString(), c06061) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c06061.$limit - 1 || !matcher.find()) {
                        charSequence = c06061.$input;
                        c06061.L$0 = null;
                        c06061.L$1 = null;
                        c06061.label = 3;
                        if ($this$sequence.yield(charSequence.subSequence(nextStart, charSequence.length()).toString(), c06061) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                ...
                case 2:
                    c06061 = this;
                    splitCount = c06061.I$0;
                    matcher = (Matcher) c06061.L$1;
                    $this$sequence = (SequenceScope) c06061.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c06061.$limit - 1) {
